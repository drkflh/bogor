...
<div class="form-row">
    ...
    <div style="width: 125px;padding-right:15px;">
        {!! $confidentiality ?? '' !!}
    </div>
{{--    @if($_isCreate)--}}
...
<div class="row" style="margin-left:3px;">
    ...
    <div class="col-4" style="border-right: thin solid #000000;border-left: thin solid #000000;">
        <h6 style="color:#000000; font-size:17px;"><b>Tembusan dan Lampiran:</b></h6>
        <div class="row">
            <div class="col-12">
                {!! $copy ?? '' !!}
            </div>
    ...
    <div class="col-4">
        <h6 style="color:#000000; font-size:17px;"><b>Draft :</b></h6>
        <div class="row">
            <div class="col-12">
                {!! $draftRecipient ?? '' !!}
            </div>
