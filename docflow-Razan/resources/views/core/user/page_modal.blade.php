    ...
    <div class="row" id="changePinForm">
        <div class="col-12">
            <validation-observer v-slot="{ invalid }" ref="changePinForm">
                <validation-provider rules="'required|is:new_confirm_pin|digits:6'" v-slot="{ errors }" name="new_pin">
                    <p class="mt-2">PIN</p>
                        <pin-input
                            v-model="new_pin"
                            name="new_pin"
                ...
                <validation-provider rules="'required'" v-slot="{ errors }" name="new_confirm_pin">
