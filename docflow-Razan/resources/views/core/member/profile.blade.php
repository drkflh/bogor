                ...
                <div class="profile-header">
                    <div class="cover">
                        ...
                        <div class="cover-body d-flex justify-content-between align-items-center">
                            <div>
                                <img class="profile-pic" src="{{ (isset(Auth::user()->avatar))?\App\Helpers\AuthUtil::getAvatar( Auth::user()->avatar, url('images/coffee.png') )  : url('images/coffee.png') }}" alt="profile">
