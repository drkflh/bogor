<template>
    <div class="st-modal">
        ...
        >
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <input type="text" v-model="sectionInput" class="form-control"></input>
                </div>
            </div>
        </b-modal>
        ...
        >
            ...
            <input type="text" v-model="formCategorySection" class="form-control"></input>
            <div class="row">
                <div class="col-2">
                ...
                <div class="col-10">
                    ...
                    <input type="text" v-model="categoryInput" class="form-control"></input>
                </div>
            </div>
        </b-modal>
            ...
            <validation-observer v-slot="{ invalid }" ref="edit_veeObserver">
                <div class="row">
                    ...
                    <div class="col-5">
                        ...
                        <validation-provider rules="" v-slot="{ errors }" name="form section">
                            <input type="text"
                                   name="formSection"
                                   v-model="formSection"
                                   class="form-control  "
                    ...
                    <div class="col-5">
                        ...
                        <validation-provider rules="" v-slot="{ errors }" name="form category">
                            <input type="text"
                                   name="formCategory"
                ...
                <div class="row">
                    <div class="col-2">
                        ...
                        <validation-provider rules="" v-slot="{ errors }" name="seq">
                            <input type="number"
                                   name="seq"
                                   v-model="seq"
                    ...
                    <div class="col-10">
                        ...
                        <validation-provider rules="" v-slot="{ errors }" name="question">
                    <textarea
                        name="question"
                        v-model="question"
                        class="form-control  "
                ...
                <div class="row">
                    <div class="col-9">
                        ...
                        <validation-provider rules="" v-slot="{ errors }" name="question type">
                            <b-form-select
                ...
                <div class="row">
                    <div class="col-9">
                        ...
                        <validation-provider rules="" v-slot="{ errors }" name="default / single answer">
                            <input type="text"
                                   name="defaultAnswer"
                    ...
                    <div class="col-3">
                        ...
                        <validation-provider rules="" v-slot="{ errors }" name="default / single score">
                            <input type="number"
                                   name="defaultScore"
