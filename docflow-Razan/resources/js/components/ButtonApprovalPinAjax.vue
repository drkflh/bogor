<template>
    <div style="display:inline-block;">
        ...
        <b-modal :id="modalId"
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-12 d-none d-md-inline-block">
                                <div id="printedItemContentFrame"
                                    ...
                                    <iframe :src="docUrl" id="pdf-view-iframe"
                                    ...
                                    <div class="col-12" style="height: 300px;overflow: auto;">
                                        <b-list-group class="p-1">
                                            <b-form-checkbox-group
                                                ...
                                                v-model="selectedApprovalItems"
                                                name="checkbox-approval-item"
                                            >
                                                <b-list-group-item v-for="(it, key, idx) in docList"
                                                                   :key="it._id">
                                                    <div class="d-flex align-items-start">
                                                        <b-form-checkbox :value="it"></b-form-checkbox>
                                                        <div class="d-flex flex-column p-0" @click="viewDoc(it)" style="cursor:pointer;" >
                                                            <h6 style="font-size: 11pt;margin-top:0px;">
                                                                {{ it.approvalTitle }}</h6>
                                                            <p style="font-size: 10pt;margin-bottom:0px;">
                                                                {{ it.approvalDescription }}</p>
                                                        </div>
                                                    </div>
                                                </b-list-group-item>
                                            </b-form-checkbox-group>
            ...
            <div class="d-flex justify-content-end" style="display: block;padding-top: 25px;">
                <div class="form-row">
    ...
    methods: {
        ...
        save() {
            ...
            let data = {
                ...
                selectedApprovalItems : this.selectedApprovalItems,
            };
