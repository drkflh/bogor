...
use App\Models\Central\Project\Reference\ProjectType;

class ProjectTypeController extends ApiAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'projecttype'; // name of yml ,ie: member.yml
        $this->entity = 'projecttype';
