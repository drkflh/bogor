...
use App\Models\Workflow\ApprovalPolicy;

class ApprovalPolicyController extends ApiAdminController
{

    public function __construct()
    {
        $this->controller_name = strtolower( str_replace('Controller', '', get_class()) );
        $this->model = new ApprovalPolicy();

        $this->res_path = 'models'; // under resources ,ie: resources/models
        $this->yml_file = 'approval_policy'; // name of yml ,ie: member.yml
        $this->entity = 'approvalpolicy';
