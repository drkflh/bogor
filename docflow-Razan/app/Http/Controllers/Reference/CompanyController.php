...
//        $this->res_path = 'models/controllers/reference/company';
//        $this->yml_file = 'fields';

        $this->res_path = 'models/controllers/reference';
        $this->yml_file = 'company_controller';

        $this->entity = 'Company';

        $this->auth_entity = 'company';

        $this->controller_base = 'reference/company';

        $this->view_base = 'reference.company';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_layout = 'reference.company.formlayout';
        $this->viewer_dialog_size = 'lg';

        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'reference.company.formlayout';
        ...
        $this->add_title_fields = '"<h4> Add Company</h4>"';
        $this->view_title_fields = '"View" + " " +this.companyName' ;
        $this->update_title_fields = '"Update" + " " +this.companyName' ;
