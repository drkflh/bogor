...

{
    public function __construct()
    {
        ...
        $this->res_path = 'views/reference/productcategory';
        $this->yml_file = 'fields';

        $this->entity = 'Product Category';

        $this->auth_entity = 'product-category';

        $this->controller_base = 'reference/product-category';

        $this->view_base = 'reference.productcategory';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_layout = 'reference.productcategory.formlayout';

        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'reference.productcategory.formlayout';
        ...
        $this->add_title_fields = '"<h4> Add Product Category</h4>"';
        $this->view_title_fields = '"View"  + " " + this.categoryName';
        $this->update_title_fields = '"Update" +  " " + this.categoryName';
