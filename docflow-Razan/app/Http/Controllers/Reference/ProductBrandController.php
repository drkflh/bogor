...

{
    public function __construct()
    {
        ...
        $this->res_path = 'views/reference/productbrand';
        $this->yml_file = 'fields';

        $this->entity = 'Product Brand';

        $this->auth_entity = 'product-brand';

        $this->controller_base = 'reference/product-brand';

        $this->view_base = 'reference.productbrand';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_layout = 'reference.productbrand.formlayout';

        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'reference.productbrand.formlayout';
        ...
        $this->add_title_fields = '"<h4> Add Product Brand</h4>"';
        $this->view_title_fields = '"View"  + " " + this.brandName';
        $this->update_title_fields = '"Update" +  " " + this.brandName';
    ...
    public function beforeSave($data)
    {
        ...
        $data['version'] = config('dbversions.product_brands');
