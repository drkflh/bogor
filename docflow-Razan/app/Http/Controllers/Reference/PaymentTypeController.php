...

{
    public function __construct()
    {
        ...
        $this->res_path = 'views/reference/paymenttype';
        $this->yml_file = 'fields';

        $this->entity = 'Payment Type';

        $this->auth_entity = 'payment-type';

        $this->controller_base = 'reference/payment-type';

        $this->view_base = 'reference.paymenttype';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_layout = 'reference.paymenttype.formlayout';

        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'reference.paymenttype.formlayout';
        ...
        $formOptions['paymentCategoryCodeOptions'] = LoyaltyUtil::toOptions(LoyaltyUtil::getPaymentCategory(), 'paymentCategoryName', 'paymentCategoryCode', false);

        $this->aux_data = $formOptions;

        $this->add_title_fields = '"<h4> Add Payment Type</h4>"';
        $this->view_title_fields = '"View"  + " " + this.paymentName';
        $this->update_title_fields = '"Update" +  " " + this.paymentName';
    ...
    public function beforeSave($data)
    {
        ...
        $data['version'] = config('dbversions.payment_types');
