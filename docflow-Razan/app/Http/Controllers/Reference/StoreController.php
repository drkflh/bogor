...

{
    public function __construct()
    {
        ...
        $this->res_path = 'views/reference/store';
        $this->yml_file = 'fields';

        $this->entity = 'Store';

        $this->auth_entity = 'store';

        $this->controller_base = 'reference/store';

        $this->view_base = 'reference.store';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_type = 'html';

        $this->viewer_layout = 'reference.store.formlayout';

        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'reference.store.formlayout';
        ...
        $formOptions['companyCodeOptions'] = LoyaltyUtil::toOptions(LoyaltyUtil::getCompany(), 'companyName', 'companyCode', false);
        $formOptions['locationCodeOptions'] = LoyaltyUtil::toOptions(LoyaltyUtil::getLocation(), 'locationName', 'locationCode', false);

        $this->aux_data = $formOptions;

        $this->add_title_fields = '"<h4> Add Store</h4>"';
        $this->view_title_fields = '"View"  + " " + this.storeName';
        $this->update_title_fields = '"Update" +  " " + this.storeName';
    ...
    public function beforeSave($data)
    {
        ...
        $data['version'] = config('dbversions.stores');
