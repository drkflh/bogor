...
//        $this->res_path = 'views/reference/jobtitle';
//        $this->yml_file = 'fields';

        $this->res_path = 'models/controllers/reference';
        $this->yml_file = 'jobtitle_controller';

        $this->entity = 'Kode Jabatan';

        $this->auth_entity = 'company-type';

        $this->controller_base = 'reference/job-title';

        $this->view_base = 'reference.jobtitle';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_layout = 'reference.jobtitle.formlayout';

        /* Use custom form layout */
        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'reference.jobtitle.formlayout';
        ...
        $this->add_title_fields = '"'.__('Add').' Kode Jabatan"';
