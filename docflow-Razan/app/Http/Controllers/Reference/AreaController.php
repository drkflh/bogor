...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'area_controller';

        $this->entity = 'Area';

        $this->auth_entity = 'area';

        $this->controller_base = 'reference/area';

        $this->view_base = 'reference.area';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_layout = 'reference.area.formlayout';

        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'reference.area.formlayout';
        ...
        $this->add_title_fields = '"<h4> Add Area</h4>"';
        $this->view_title_fields = '"View Area"';
        $this->update_title_fields = '"Update Area"';
