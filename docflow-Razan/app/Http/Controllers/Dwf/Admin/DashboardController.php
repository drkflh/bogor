...
class DashboardController extends AdminController
{
    ...
    public function getData($id, $additional_data = null)
    {
        ...
        $totalNotaDinas = NumberUtil::decimal($notaDinas->count());
        $totalSuratDinas = NumberUtil::decimal($suratDinas->count());
        $totalDisposisi = NumberUtil::decimal($lembarDisposisi->count());
        $totalMemoInternal = NumberUtil::decimal($memoInternal->count());
        ...
        $totalNotaDinasApproved = NumberUtil::decimal($notaDinasApproved->count());
        $totalSuratDinasApproved = NumberUtil::decimal($suratDinasApproved->count());
        $totalDisposisiApproved = NumberUtil::decimal($lembarDisposisiApproved->count());
        $totalMemoInternalApproved = NumberUtil::decimal($memoInternalApproved->count());
