...

{
    ...
    public function getIndex()
    {
        ...
        $this->data_url = 'obj/form';

        $this->add_url = 'obj/form/add';

        $this->update_url = 'obj/form/edit';

        $this->del_url = 'obj/form/del';

        $this->item_data_url = 'obj/form/data';
        ...
        //$this->table_slot_view = 'obj.form.tableslot';
