...

{
    ...
    public function getIndex()
    {
        ...
        $this->data_url = 'obj/page';

        $this->add_url = 'obj/page/add';

        $this->update_url = 'obj/page/edit';

        $this->del_url = 'obj/page/del';

        $this->item_data_url = 'obj/page/data';
        ...
        //$this->table_slot_view = 'obj.page.tableslot';
