...
use App\Models\Cars\CarMfg;
use App\Models\Core\Mongo\User;
use App\Models\Pricing\PriceCriteria;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class PriceCriteriaController extends AdminController

{
    public function __construct()
    {
        ...
        $this->model = new PriceCriteria();
    }

    public function getIndex()
    {
        $this->title = 'Pricing Criteria';
        ...
        $this->res_path = 'views/pricing/pricecriteria';
        ...
        $this->data_url = 'price/criteria';

        $this->add_url = 'price/criteria/add';

        $this->update_url = 'price/criteria/edit';

        $this->item_data_url = 'price/criteria/data';

        $this->param_url = 'price/criteria/param';

        $this->del_url = 'price/criteria/del';

        $this->clone_url = 'price/criteria/clone';

        $this->download_url = 'price/criteria/dlxl';
        ...
        $this->import_commit_url = 'price/criteria/commit';

        $this->logo = env('APP_LOGO');

        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'pricing.pricecriteria.formlayout';
        $this->form_dialog_size = 'md';

        $this->table_slot_view = 'pricing.pricecriteria.table_slot';
        $this->table_head_slot_view = 'pricing.pricecriteria.table_head_slot';
        $this->table_action_view = 'pricing.pricecriteria.table_action';
        $this->table_modal_view = 'pricing.pricecriteria.table_modal';

        $this->table_methods_view = 'pricing.pricecriteria.table_methods';
        $this->table_computed_view = 'pricing.pricecriteria.table_computed';
        $this->table_watch_view = 'pricing.pricecriteria.table_watch';


        $this->add_methods_view = 'pricing.pricecriteria.add_methods';
        $this->add_computed_view = 'pricing.pricecriteria.add_computed';
        $this->add_watch_view = 'pricing.pricecriteria.add_watch';

        $this->edit_methods_view = 'pricing.pricecriteria.edit_methods';
        $this->edit_computed_view = 'pricing.pricecriteria.edit_computed';
        $this->edit_watch_view = 'pricing.pricecriteria.edit_watch';
