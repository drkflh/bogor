...
use App\Models\Vehicle\CarMfg;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class VehicleMfgController extends AdminController

{
    public function __construct()
    {
        ...
        $this->model = new CarMfg();
    }

    public function getIndex()
    {
        $this->title = 'Manufacturing';

        $cname = substr(strrchr(get_class($this), '\\'), 1);
        $this->controller_name = str_replace('Controller', '', $cname);

        //$this->nav_section = 'assets';
        $this->res_path = 'views/cars/vehiclemfg';
        ...
        $this->data_url = 'assets/vehiclemfg';

        $this->add_url = 'assets/vehiclemfg/add';

        $this->update_url = 'assets/vehiclemfg/edit';

        $this->item_data_url = 'assets/vehiclemfg/data';

        $this->param_url = 'assets/vehiclemfg/param';

        $this->del_url = 'assets/vehiclemfg/del';

        $this->clone_url = 'assets/vehiclemfg/clone';

        $this->download_url = 'assets/vehiclemfg/dlxl';
        ...
        $this->import_commit_url = 'assets/vehiclemfg/commit';
        ...
        */
        ...
        $this->form_layout = 'cars.vehiclemfg.formlayout';

        $this->table_slot_view = 'cars.vehiclemfg.table_slot';
        $this->table_head_slot_view = 'cars.vehiclemfg.table_head_slot';
        $this->table_action_view = 'cars.vehiclemfg.table_action';
        $this->table_modal_view = 'cars.vehiclemfg.table_modal';

        $this->table_methods_view = 'cars.vehiclemfg.table_methods';
        $this->table_computed_view = 'cars.vehiclemfg.table_computed';
        $this->table_watch_view = 'cars.vehiclemfg.table_watch';


        $this->add_methods_view = 'cars.vehiclemfg.add_methods';
        $this->add_computed_view = 'cars.vehiclemfg.add_computed';
        $this->add_watch_view = 'cars.vehiclemfg.add_watch';

        $this->edit_methods_view = 'cars.vehiclemfg.edit_methods';
        $this->edit_computed_view = 'cars.vehiclemfg.edit_computed';
        $this->edit_watch_view = 'cars.vehiclemfg.edit_watch';
