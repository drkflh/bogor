...

{
    ...
    public function __construct()
    {
        ...
        $this->res_path = 'views/assets/fixedasset';
        $this->yml_file = 'fields';

        $this->model = new FixedAsset();
    }

    public function getIndex()
    {
        $this->title = 'Fixed Asset';
        ...
        $this->data_url = 'assets/fixed';

        $this->add_url = 'assets/fixed/add';

        $this->update_url = 'assets/fixed/edit';

        $this->item_data_url = 'assets/fixed/data';

        $this->del_url = 'assets/fixed/del';
