...
use App\Models\Dwf\DocDisposal;
...
//        $this->res_path = 'views/dwf/admin/disposal';
//        $this->yml_file = 'fields';
        ...
        $this->controller_base = 'dwf/admin/disposal';

        $this->view_base = 'dwf.admin.disposal';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_layout = 'dwf.admin.disposal.formlayout';
        $this->viewer_dialog_size = 'md';

        /* Use custom form layout */
        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'dwf.admin.disposal.formlayout';
        $this->form_dialog_size = 'md';

        $formOptions = Util::loadResYaml($this->yml_file,$this->res_path)->toFormOption();

        $formOptions['labelTemplate'] = '`'.file_get_contents( resource_path('views/dwf/admin/disposal/labeltemplate.html') ).'`';
        $formOptions['printTemplate'] = '`'.file_get_contents( resource_path('views/dwf/admin/disposal/printtemplate.html') ).'`';
