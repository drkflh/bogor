...
use App\Models\Halal\SponsorProgram;
...

{
    public function __construct()
    {
        ...
        $this->controller_base = 'halal/sponsor-program';

        $this->view_base = 'halal.sponsorprogram';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'halal.sponsorprogram.form_layout';
        $this->form_dialog_size = 'xl';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.sponsorprogram.view_layout';
