...
class OwnerPenyeliaProfileController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'ownerpenyeliaprofile_controller';

        $this->entity = 'Owner Penyelia Profile';

        $this->auth_entity = 'owner-penyelia-profile';

        $this->controller_base = 'halal/admin/owner-penyelia-profile';

        $this->view_base = 'halal.admin.ownerpenyeliaprofile';
    ...
    {
        $this->title = 'Owner Penyelia Profile';
        ...
        */
        ...
        $this->form_layout = 'halal.admin.ownerpenyeliaprofile.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.admin.ownerpenyeliaprofile.view_layout';
