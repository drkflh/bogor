...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'halal-vendor-directory';

        $this->controller_base = 'halal/vendor';

        $this->view_base = 'halal.admin.vendordirectory';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_layout = 'halal.admin.vendordirectory.view_layout';

        /* Use custom form layout */
        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'halal.admin.vendordirectory.form_layout';
      ...
      ->setObjFields( // mwnambahkan setting field untuk table
        ...
        ->setObjTemplate(view('halal.admin.vendordirectory.contact')->render() ) // set template
        ...
        $formOptions['vendorClassOptions'] = config('app.halal.vendorClass');
...
//        $this->defOrderDir = 'desc';
    ...
    public function getList(Request $request, $keyword0, $keyword1 = null, $keyword2 = null)
    {
        ...
        if($keyword0 != ''){
            ...
            if( View::exists('halal.admin.vendordirectory.'.$layout) ){
                $form_layout = $layout;
        ...
        $this->auth_entity = 'halal-'.trim($keyword0);
