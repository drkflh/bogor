...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'halal-business-register';

        $this->controller_base = 'halal/business-register';

        $this->view_base = 'halal.business';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'halal.business.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.business.view_layout';
    ...
    public function getAdd(Request $request, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->page_methods_view = 'halal.business.add_methods';
        $this->page_computed_view = 'halal.business.add_computed';
        $this->page_watch_view = 'halal.business.add_watch';
    ...
    public function getEdit(Request $request, $id, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->page_methods_view = 'halal.business.edit_methods';
        $this->page_computed_view = 'halal.business.edit_computed';
        $this->page_watch_view = 'halal.business.edit_watch';
    ...
    {
        $geoFenceTemplate = "'".view('halal.business.geofence')->render()."'" ;
