...
use App\Models\Halal\Reference\LembagaPendamping;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class LembagaPendampingController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'lembagapendamping_controller';

        $this->entity = 'Lembaga Pendamping';

        $this->auth_entity = 'lembaga-pendamping';

        $this->controller_base = 'halal/admin/reference/lembaga-pendamping';

        $this->view_base = 'halal.reference.lembagapendamping';

        $this->model = new LembagaPendamping();
    }

    public function getIndex()
    {
        $this->title = 'Lembaga Pendamping';
        ...
        */
        ...
        $this->form_layout = 'halal.reference.lembagapendamping.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.lembagapendamping.view_layout';
        ...
        $this->view_title_fields = 'this.nama_lembaga';
    ...
    public function getEdit(Request $request, $id, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->title = __('Edit').' '.$item->nama_lembaga;
