...
use App\Models\Halal\Reference\Kecamatan;
...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'kecamatan_controller';

        $this->entity = 'Kecamatan';

        $this->auth_entity = 'kecamatan';

        $this->controller_base = 'halal/admin/reference/kecamatan';

        $this->view_base = 'halal.reference.kecamatan';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'halal.reference.kecamatan.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.kecamatan.view_layout';
        ...
        $this->update_title_fields = '"<h4>'.__('Edit')." ".'" + this.namaKecamatan + "</h4>"';
        $this->view_title_fields = '"<h4>'.__('View')." ".'" + this.namaKecamatan + "</h4>"';
