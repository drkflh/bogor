...
use App\Models\Halal\Reference\AreaPemasaran;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class AreaPemasaranController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'areapemasaran_controller';

        $this->entity = 'Area Pemasaran';

        $this->auth_entity = 'area-pemasaran';

        $this->controller_base = 'halal/admin/reference/area-pemasaran';

        $this->view_base = 'halal.reference.areapemasaran';

        $this->model = new AreaPemasaran();
    }

    public function getIndex()
    {
        $this->title = 'Area Pemasaran';
        ...
        */
        ...
        $this->form_layout = 'halal.reference.areapemasaran.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.areapemasaran.view_layout';
        ...
        $this->view_title_fields = '"<h4>'.__('Lihat Area Pemasaran').' " + "</h4>"' ;
        $this->update_title_fields = '"<h4>'.__('Ubah Data Area Pemasaran').' " + "</h4>"' ;
