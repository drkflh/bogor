...
use App\Models\Halal\Reference\Pekerjaan;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class PekerjaanController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'pekerjaan_controller';

        $this->entity = 'Pekerjaan';

        $this->auth_entity = 'pekerjaan';

        $this->controller_base = 'halal/admin/reference/pekerjaan';

        $this->view_base = 'halal.reference.pekerjaan';
    ...
    public function getIndex()
    {
        ...
        $this->form_layout = 'halal.reference.pekerjaan.form_layout';
        $this->form_dialog_size = 'md';

        /**
         * Set Viewer layout
         */
        $this->viewer_layout = 'halal.reference.pekerjaan.view_layout';
