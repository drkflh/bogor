...
use App\Models\Halal\Reference\Kabupaten;
...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'kabupaten_controller';

        $this->entity = 'Kabupaten';

        $this->auth_entity = 'kabupaten';

        $this->controller_base = 'Halal/Reference/Kabupaten';

        $this->view_base = 'halal.reference.kabupaten';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'halal.reference.kabupaten.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.kabupaten.view_layout';
        ...
        $this->update_title_fields = '"<h4>'.__('Edit')." ".'" + this.namaKabupaten + "</h4>"';
        $this->view_title_fields = '"<h4>'.__('View')." ".'" + this.namaKabupaten + "</h4>"';
