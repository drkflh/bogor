...
use App\Models\Halal\Reference\AsalPelaku;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class AsalPelakuController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'asalpelaku_controller';

        $this->entity = 'Asal Pelaku';

        $this->auth_entity = 'asal-pelaku';

        $this->controller_base = 'halal/admin/reference/asal-pelaku';

        $this->view_base = 'halal.reference.asalpelaku';

        $this->model = new AsalPelaku();
    }

    public function getIndex()
    {
        $this->title = 'Asal Pelaku Usaha';
        ...
        */
        ...
        $this->form_layout = 'halal.reference.asalpelaku.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.asalpelaku.view_layout';
        ...
        $this->view_title_fields = '"<h4>'.__('Lihat Asal Pelaku Usaha').' " + "</h4>"' ;
        $this->update_title_fields = '"<h4>'.__('Ubah Data Asal Pelaku Usaha').' " + "</h4>"' ;
