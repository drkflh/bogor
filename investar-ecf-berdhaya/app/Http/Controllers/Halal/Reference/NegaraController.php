...
use App\Models\Halal\Reference\Negara;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class NegaraController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'negara_controller';

        $this->entity = 'Negara';

        $this->auth_entity = 'negara';

        $this->controller_base = 'Halal/Reference/Negara';

        $this->view_base = 'halal.reference.negara';

        $this->model = new Negara();
    }
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'halal.reference.negara.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.negara.view_layout';
        ...
        $this->update_title_fields = '"<h4>'.__('Edit')." ".'" + this.namaNegara + "</h4>"';
        $this->view_title_fields = '"<h4>'.__('View')." ".'" + this.namaNegara + "</h4>"';
    ...
    public function getEdit(Request $request, $id, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->title_fields = __('Edit').' '.$this->entity;
