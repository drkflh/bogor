...
use App\Models\Halal\Reference\SelfDeclare;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class SelfDeclareController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'selfdeclare_controller';

        $this->entity = 'Self Declare';

        $this->auth_entity = 'self-declare';

        $this->controller_base = 'halal/admin/reference/self-declare';

        $this->view_base = 'halal.reference.selfdeclare';

        $this->model = new SelfDeclare();
    }

    public function getIndex()
    {
        $this->title = 'Self Declare';
        ...
        */
        ...
        $this->form_layout = 'halal.reference.selfdeclare.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.selfdeclare.view_layout';
        ...
        $this->view_title_fields = '"<h4>'.__('Lihat Jenis Usaha').' " + "</h4>"' ;
        $this->update_title_fields = '"<h4>'.__('Ubah Data Jenis Usaha').' " + "</h4>"' ;
    ...
    public function getEdit(Request $request, $id, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->title = __('Edit').' '.$item->ref_id;
