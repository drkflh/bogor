...
use App\Models\Halal\Reference\SkalaUsaha;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class SkalaUsahaController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'skalausaha_controller';

        $this->entity = 'Skala Usaha';

        $this->auth_entity = 'skala-usaha';

        $this->controller_base = 'halal/admin/reference/skala-usaha';

        $this->view_base = 'halal.reference.skalausaha';

        $this->model = new SkalaUsaha();
    }

    public function getIndex()
    {
        $this->title = 'Skala Usaha';
        ...
        */
        ...
        $this->form_layout = 'halal.reference.skalausaha.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.skalausaha.view_layout';
        ...
        $this->view_title_fields = '"<h4>'.__('Lihat Skala Usaha').' " + "</h4>"' ;
        $this->update_title_fields = '"<h4>'.__('Ubah Data Skala Usaha').' " + "</h4>"' ;
