...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'jenisusaha_controller';

        $this->entity = 'Jenis Usaha';

        $this->auth_entity = 'jenis-usaha';

        $this->controller_base = 'halal/admin/reference/jenis-usaha';

        $this->view_base = 'halal.reference.jenisusaha';

        $this->model = new JenisUsaha();
    }
    ...
    public function getIndex()
    {
        ...
        $this->form_layout = 'halal.reference.jenisusaha.form_layout';
        $this->form_dialog_size = 'md';

        /**
         * Set Viewer layout
         */
        $this->viewer_layout = 'halal.reference.jenisusaha.view_layout';
