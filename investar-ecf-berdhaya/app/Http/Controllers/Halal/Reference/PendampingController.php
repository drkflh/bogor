...
use App\Models\Halal\Reference\Pendamping;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class PendampingController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'pendamping_controller';

        $this->entity = 'Pendamping';

        $this->auth_entity = 'pendamping';

        $this->controller_base = 'halal/admin/reference/pendamping';

        $this->view_base = 'halal.reference.pendamping';

        $this->model = new Pendamping();
    }

    public function getIndex()
    {
        $this->title = 'Profile Pendamping';
        ...
        */
        ...
        $this->form_layout = 'halal.reference.pendamping.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.pendamping.view_layout';
        ...
        $this->view_title_fields = '"<h4>'.__('Lihat Pendamping').' " + "</h4>"' ;
        $this->update_title_fields = '"<h4>'.__('Ubah Data Pendamping').' " + "</h4>"' ;
