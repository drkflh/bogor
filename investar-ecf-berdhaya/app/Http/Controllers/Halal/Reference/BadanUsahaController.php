...
use App\Models\Halal\Reference\JenisBadanUsaha;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class BadanUsahaController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'badanusaha_controller';

        $this->entity = 'Badan Usaha';

        $this->auth_entity = 'badan-usaha';

        $this->controller_base = 'halal/admin/reference/jenis-badan-usaha';

        $this->view_base = 'halal.reference.badanusaha';

        $this->model = new JenisBadanUsaha();
    }
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'halal.reference.badanusaha.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.reference.badanusaha.view_layout';
        ...
        $this->view_title_fields = '"<h4>'.__('Lihat Jenis Badan Usaha').' " + "</h4>"' ;
        $this->update_title_fields = '"<h4>'.__('Ubah Data Jenis Badan Usaha').' " + "</h4>"' ;
