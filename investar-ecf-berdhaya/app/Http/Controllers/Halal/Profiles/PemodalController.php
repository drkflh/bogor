...

{
    public function __construct()
    {
        ...
        $this->controller_base = 'halal/profile/pemodal';

        $this->view_base = 'halal.profiles.pemodal';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'halal.profiles.pemodal.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.profiles.pemodal.view_layout';
    ...
    public function getStep(Request $request, $step = 1, $id = null, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $formlayout = 'halal.profiles.pemodal.step_'.$step;
        ...
        $this->step_progress = [
            ...
            [
                ...
                'description'=>'Profil Investasi',
                'active'=>( $this->current_step >= 2 )
            ],
            [
                'title'=>'Financial Info',
                'description'=>'Financial Information & Attachments',
                'active'=>( $this->current_step >= 3 )
            ],
            [
                'title'=>'Secondary Contact',
                'description'=>'Last Step of This Process',
    ...
    public function getAdd(Request $request, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        /* Use custom form layout */
        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'halal.profiles.pemodal.step_1';
