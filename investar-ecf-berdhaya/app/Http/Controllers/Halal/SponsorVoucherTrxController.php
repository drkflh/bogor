...
use App\Models\Halal\SponsorVoucherTrx;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class SponsorVoucherTrxController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'sponsorvouchertrx_controller';

        $this->entity = 'Voucher Transactions';

        $this->auth_entity = 'sponsor-voucher-trx';

        $this->controller_base = 'halal/sponsor-voucher-trx';

        $this->view_base = 'halal.sponsorvouchertrx';

        $this->model = new SponsorVoucherTrx();
    }

    public function getIndex()
    {
        $this->title = 'Voucher Transactions';
        ...
        */
        ...
        $this->form_layout = 'halal.sponsorvouchertrx.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.sponsorvouchertrx.view_layout';
        ...
        $this->update_title_fields = '"<h4>'.__('Ubah')." ".'" + this.voucherCode + "</h4>"';
        $this->view_title_fields = '"<h4>'.__('Lihat')." ".'" + this.voucherCode + "</h4>"';
    ...
    public function getEdit(Request $request, $id, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->title = __('Edit').' '.$item->voucherCode;
