...
use App\Models\Halal\ValidatorProfile;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class ValidatorProfileController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'validatorprofile_controller';

        $this->entity = 'Validator Profile';

        $this->auth_entity = 'validator-profile';

        $this->controller_base = 'halal/validator-profile';

        $this->view_base = 'halal.validatorprofile';

        $this->model = new ValidatorProfile();
    }

    public function getIndex()
    {
        $this->title = 'Validator Profile';
        ...
        */
        ...
        $this->form_layout = 'halal.validatorprofile.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.validatorprofile.view_layout';
