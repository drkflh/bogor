...
class FundingApprovalController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'fundingapproval_controller';

        $this->entity = 'Funding Approval';

        $this->auth_entity = 'funding-approval';

        $this->controller_base = 'halal/funding-approval';

        $this->view_base = 'halal.fundingapproval';
    ...
    public function getIndex()
    {
        ...
        $this->form_layout = 'halal.fundingapproval.form_layout';
        $this->form_dialog_size = 'lg';

        /**
         * Set Viewer layout
         */
        $this->viewer_layout = 'halal.fundingapproval.view_layout';
    ...
    {
        $formOptions['approvalDetailTemplate'] = '`' . view('halal.fundingapproval.approvaldetail')->render() . '`';
    ...
    protected function rowPostProcess($row)
    {
        ...
        $row['decideAs'] = $as;
        $title = $row['requestNo'] ?? "Funding Approval";
    ...
    public function additionalQuery($model, Request $request)
    {
        ...
        $model = $model->where('approvalStatus', 'AUDIT')->orderBy('updatedAt', 'desc');
        return $model;
    }
