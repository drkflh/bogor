...
class SponsorVoucherController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'sponsorvoucher_controller';

        $this->entity = 'Voucher Repository';

        $this->auth_entity = 'sponsor-voucher';

        $this->controller_base = 'halal/sponsor-voucher';

        $this->view_base = 'halal.sponsorvoucher';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'halal.sponsorvoucher.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'halal.sponsorvoucher.view_layout';
