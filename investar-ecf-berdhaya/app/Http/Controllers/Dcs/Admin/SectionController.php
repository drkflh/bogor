...

{
    public function __construct()
    {
        ...
        $this->entity = 'Section';
        $this->view_base = 'dcs.admin.section';
        $this->auth_entity = 'cms-section';
        $this->controller_base = 'dcs/admin/section';
    ...
    public function getIndex()
    {
        ...
        $this->import_commit_url = 'dcs/admin/section/commit';

        $this->logo = env('APP_LOGO');

        $this->show_title = true;

        $this->viewer_layout = 'dcs.admin.section.formlayout';

        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'dcs.admin.section.formlayout';
