 ...
 * Time: 23.33
 */
namespace App\Http\Controllers\Reflow;

use App\Helpers\App\QontakUtil;
use App\Helpers\Util;
use App\Helpers\Injector;
use App\Http\Controllers\Core\AdminController;
use App\Models\Reflow\DecisionRule;
use Carbon\Carbon;
use Illuminate\Http\Request;

class DecisionRuleController extends AdminController

{
    public function __construct()
    {
        ...
        $this->res_path = 'models/controllers/reflow';

        $this->yml_file = 'decisionrule_controller';

        $this->entity = 'Decision Rule';

        $this->auth_entity = 'decision-rule';

        $this->controller_base = 'reflow/decision-rule';

        $this->view_base = 'reflow.decisionrule';

        $this->model = new DecisionRule();
    }

    public function getIndex()
    {
        $this->title = 'Decision Rule';
        ...
        */
        ...
        $this->form_layout = 'reflow.decisionrule.form_layout';
        $this->form_dialog_size = 'xl';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'reflow.decisionrule.view_layout';
    ...
    public function setupInjector($uiOptions, $data = null)
    {
        ...
        $uiOptions = Injector::setObject('paramList') // name variable / field yang akan diinject
            ->setObjFields( // mwnambahkan setting field untuk table
                [
                    [ 'label'=>'Key', 'key'=>'paramKey', 'class'=>'text-150' , 'type'=>'String' , 'validator'=>'required'  ],
                    [ 'label'=>'Field Type', 'key'=>'paramType', 'class'=>'text-50', 'type'=>'String' , 'validator'=>''  ],
                ]
            ...
            ->setObjTemplate( view('reflow.decisionrule.paramlist')->render() ) // set template
