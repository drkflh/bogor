...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'cycle_controller';

        $this->entity = 'Cycle';

        $this->auth_entity = 'cycle';

        $this->controller_base = 'reflow/cycle';

        $this->view_base = 'reflow.cycle';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'reflow.cycle.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'reflow.cycle.view_layout';
        ...
        $this->title_fields = 'cycleName';

        $this->clone_name_field = 'cycleName';
    ...
    {
        return parent::setupFormOptions($formOptions, $data); // TODO: C`hange the autogenerated stub
    }
...
//        $this->defOrderDir = 'asc';
    ...
    {
        $model = $model->orderBy('cycleGroup', 'asc')
            ->orderBy('seq','asc');
