...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'breed_controller';

        $this->entity = 'Breed';

        $this->auth_entity = 'breed';

        $this->controller_base = 'fms/admin/breed';

        $this->view_base = 'fms.admin.breed';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'fms.admin.breed.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'fms.admin.breed.view_layout';
        ...
        $this->add_title_fields = '"<h4> Add Breed</h4>"';
