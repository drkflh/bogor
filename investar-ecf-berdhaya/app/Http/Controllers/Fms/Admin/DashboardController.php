...
use App\Models\Fms\Doc;
use App\Models\Core\Mongo\User;
use App\Models\Fms\Document;
...
class DashboardController extends AdminController
{
    ...
    public function getIndex()
    {
        ...
        $this->res_path = 'views/fms/admin/dashboard';
    ...
    public function getDashboard($id = null){
        ...
        $this->item_data_url = 'fms/dashboard/data';
        ...
        $this->form_layout = 'fms.admin.dashboard.dashboard';
