...
use App\Models\Fms\UsgCheck;
use Carbon\Carbon;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Storage;

class UsgCheckController extends AdminController

{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'usgcheck_controller';

        $this->entity = 'USG Check';

        $this->auth_entity = 'fms-pregnant-check';

        $this->controller_base = 'fms/usg-check';

        $this->view_base = 'fms.usgcheck';

        $this->model = new UsgCheck();
    }

    public function getIndex()
    {
        $this->title = 'USG Check';
        ...
        */
        ...
        $this->form_layout = 'fms.usgcheck.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'fms.usgcheck.view_layout';
    ...
    public function afterSave($data)
    {
        ...
        FmsUtil::updatePregnant($data['farmNo'], $data['cattleId'], $data['isPregnant'], true ,$data ,$now);
