...
use App\Models\Fms\WeightLog;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Storage;

class WeightLogController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'weightlog_controller';

        $this->entity = 'Weight Log';

        $this->auth_entity = 'fms-weight-log';

        $this->controller_base = 'fms/weight-log';

        $this->view_base = 'fms.weightlog';

        $this->model = new WeightLog();
    }

    public function getIndex()
    {
        $this->title = 'Weight Log';
        ...
        */
        ...
        $this->form_layout = 'fms.weightlog.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'fms.weightlog.view_layout';
