...
class MedicalTreatmentController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'medicaltreatment_controller';

        $this->entity = 'Medical Treatment';

        $this->auth_entity = 'fms-medical-treatment';

        $this->controller_base = 'fms/medical-treatment';

        $this->view_base = 'fms.medicaltreatment';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'fms.medicaltreatment.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'fms.medicaltreatment.view_layout';
