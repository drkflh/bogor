...
use App\Models\Fms\EstrusCheck;
...
class EstrusCheckController extends AdminController

{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'estruscheck_controller';

        $this->entity = 'Birahi Check';

        $this->auth_entity = 'fms-fresh-check';

        $this->controller_base = 'fms/estrus-check';

        $this->view_base = 'fms.estruscheck';

        $this->model = new EstrusCheck();
    }

    public function getIndex()
    {
        $this->title = 'Birahi Check';
        ...
        */
        ...
        $this->form_layout = 'fms.estruscheck.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'fms.estruscheck.view_layout';
