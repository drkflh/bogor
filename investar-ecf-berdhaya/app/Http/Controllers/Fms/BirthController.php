...
use App\Models\Fms\Birth;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Storage;

class BirthController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'birth_controller';

        $this->entity = 'Birth';

        $this->auth_entity = 'fms-birth';

        $this->controller_base = 'fms/birth';

        $this->view_base = 'fms.birth';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'fms.birth.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'fms.birth.view_layout';
