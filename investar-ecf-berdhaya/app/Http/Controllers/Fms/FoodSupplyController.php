...
use App\Models\Fms\FoodSupply;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Storage;

class FoodSupplyController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'foodsupply_controller';

        $this->entity = 'Food Supply';

        $this->auth_entity = 'fms-food-supply';

        $this->controller_base = 'fms/food-supply';

        $this->view_base = 'fms.foodsupply';

        $this->model = new FoodSupply();
    }

    public function getIndex()
    {
        $this->title = 'Food Supply';
        ...
        */
        ...
        $this->form_layout = 'fms.foodsupply.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'fms.foodsupply.view_layout';
