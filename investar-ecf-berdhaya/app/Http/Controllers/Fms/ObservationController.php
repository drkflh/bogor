...
class ObservationController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'observation_controller';

        $this->entity = 'Observation';

        $this->auth_entity = 'fms-observation';

        $this->controller_base = 'fms/observation';

        $this->view_base = 'fms.observation';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'fms.observation.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'fms.observation.view_layout';
    ...
    public function getParam()
    {
        ...
        $this->def_param['observationDate'] = date('Y-m-d H:i:s', time());
