...
use App\Models\Fms\DairyProduction;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Storage;

class DairyProductionController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'dairyproduction_controller';

        $this->entity = 'Milk Production';

        $this->auth_entity = 'fms-dairy-production';

        $this->controller_base = 'fms/dairy-production';

        $this->view_base = 'fms.dairyproduction';

        $this->model = new DairyProduction();
    }

    public function getIndex()
    {
        $this->title = 'Milk Production';
        ...
        */
        ...
        $this->form_layout = 'fms.dairyproduction.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'fms.dairyproduction.view_layout';
