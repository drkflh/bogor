...
class PublicController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->layout = env('DEFAULT_OPEN_LAYOUT','layouts.nobleui_h');
...
//        $this->tz = $session->get('tz');
    ...
    public function getIndex()
    {
        ...
        Util::log('Anonymous', $request->url(), 'INIT' ,$request->toArray(), null , $this->auth_entity);
...
//        }
    ...
    public function getStep(Request $request, $step = 1 ,$id = null ,$keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->form_mode = is_null($id) ? 'add': 'edit';
...
//        $this->user_role_entity = AuthUtil::loadRoleEntity(Auth::user()->roleId);
        ...
        Util::log('Anonymous', $request->url(), 'PDF' ,$request->toArray(), null , $this->auth_entity);
...
//        $this->user_role_entity = AuthUtil::loadRoleEntity(Auth::user()->roleId);
        ...
        Util::log('Anonymous', $request->url(), 'HTML' ,$request->toArray(), null , $this->auth_entity);
    ...
    {
        Util::ajaxDebug();
        Util::log('Anonymous', $request->url(), 'TABLE' ,$request->toArray(), null,$this->auth_entity );
    ...
    public function postSetApprovalStatus(Request $request){
        ...
        if(empty($ids)){
            ...
            try{
                ...
                Util::log('Anonymous', $request->url(), 'APPROVE' ,$request->toArray(), 'SUCCESS: Status changed to '.$status, $this->auth_entity, $ids );
                return response()->json( ['status'=>'OK','data'=>'STATUSCHANGED' ] );

            }catch (\Exception $e){
                Util::log('Anonymous', $request->url(), 'APPROVE' ,$request->toArray(), 'ERR: '.$e->getMessage(), $this->auth_entity, $ids );
    ...
    public function postResetRevLock(Request $request){
        ...
        if(empty($ids)){
            ...
            try{
                ...
                Util::log('Anonymous', $request->url(), 'REVLOCKRESET' ,$request->toArray(), 'SUCCESS', $this->auth_entity, $ids );

                return response()->json( ['status'=>'OK','data'=>'REVLOCKRESET' ] );

            }catch (\Exception $e){
                Util::log('Anonymous', $request->url(), 'REVLOCKRESET' ,$request->toArray(), 'ERR: '.$e->getMessage(), $this->auth_entity, $ids );
                return response()->json( ['status'=>'ERR','data'=>$e->getMessage() ] );
            }
        }
    ...
    public function postDel(Request $request){
        ...
        if(empty($ids)){
            Util::log('Anonymous', $request->url(), 'DELETE' ,$request->toArray(), 'ERR: No Id specified', $this->auth_entity );
            return response()->json( ['status'=>'ERR','data'=>'NOID' ] );
        }else{
            ...
            try{
                ...
                try {
                    $actor = 'Anonymous';
                    Util::log( $actor, $request->url(), 'DELETE', $request->toArray(), 'SUCCESS', $this->auth_entity, $ids);
                } catch (\Exception $e) {
                    debug($e->getMessage());
                }
                ...
                try {
                    $actor = 'Anonymous';
                    Util::log( $actor, $request->url(), 'DELETE' ,$request->toArray(), 'ERR: '.$e->getMessage(), $this->auth_entity, $ids );
                } catch (\Exception $e) {
                    debug($e->getMessage());
                }
                return response()->json( ['status'=>'ERR','data'=>$e->getMessage() ] );
...
//        }
    ...
    {
        Util::log('Anonymous', $request->url(), 'DOWNLOAD' ,$request->toArray(), 'INIT', $this->auth_entity );
...
//
    ...
    public function getData($id, $additional_data = null)
    {
        ...
        Util::log('Anonymous', $request->url(), $action, $request->toArray(), 'OK', $this->auth_entity, $id);
    ...
    public function postCommit(Request $request)
    {
        ...
        Util::log('Anonymous', $request->url(), 'IMPORTCOMMIT' ,$request->toArray(), 'SUCCESS', $this->auth_entity );
