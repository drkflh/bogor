...

{
    ...
    public function getIndex()
    {
        ...
        $this->res_path = 'views/core/broadcast';
        ...
        $this->data_url = 'broadcast';

        $this->add_url = 'broadcast/add';

        $this->update_url = 'broadcast/edit';

        $this->del_url = 'broadcast/del';

        $this->item_data_url = 'broadcast/data';
        ...
        //$this->table_slot_view = 'broadcast.tableslot';
