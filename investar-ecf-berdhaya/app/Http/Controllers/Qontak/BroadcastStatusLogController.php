...
class BroadcastStatusLogController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'broadcaststatuslog_controller';

        $this->entity = 'Broadcast Status Log';

        $this->auth_entity = 'broadcast-status-log';

        $this->controller_base = 'mms/qontak/broadcast-status-log';

        $this->view_base = 'qontak.broadcaststatuslog';

        $this->model = new WaBroadcastStatusLog();
    }

    public function getIndex()
    {
        $this->title = 'Broadcast Status Log';
        ...
        */
        ...
        $this->form_layout = 'qontak.broadcaststatuslog.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'qontak.broadcaststatuslog.view_layout';
