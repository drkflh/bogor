...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'category';

        $this->controller_base = 'mms/qontak/category';

        $this->view_base = 'qontak.category';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'qontak.category.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'qontak.category.view_layout';
