...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'fileupload_controller';

        $this->entity = 'File Upload';

        $this->auth_entity = 'file-upload';

        $this->controller_base = 'mms/qontak/file-upload';

        $this->view_base = 'qontak.fileupload';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'qontak.fileupload.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'qontak.fileupload.view_layout';
