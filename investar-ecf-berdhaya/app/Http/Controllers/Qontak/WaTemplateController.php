...
class WaTemplateController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'watemplate_controller';

        $this->entity = 'Wa Template';

        $this->auth_entity = 'wa-template';

        $this->controller_base = 'mms/qontak/wa-template';

        $this->view_base = 'qontak.watemplate';

        $this->model = new WaTemplate();
    }

    public function getIndex()
    {
        $this->title = 'Wa Template';
        ...
        */
        ...
        $this->form_layout = 'qontak.watemplate.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'qontak.watemplate.view_layout';
