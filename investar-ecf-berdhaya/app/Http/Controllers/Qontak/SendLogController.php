...
class SendLogController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'sendlog_controller';

        $this->entity = 'Send Log';

        $this->auth_entity = 'send-log';

        $this->controller_base = 'mms/qontak/send-log';

        $this->view_base = 'qontak.sendlog';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'qontak.sendlog.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'qontak.sendlog.view_layout';
