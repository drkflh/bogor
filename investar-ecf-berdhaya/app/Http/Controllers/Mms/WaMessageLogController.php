...
class WaMessageLogController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'wamessagelog_controller';

        $this->entity = 'Wa Message Log';

        $this->auth_entity = 'wa-message-log';

        $this->controller_base = 'mms/wa-message-log';

        $this->view_base = 'mms.wamessagelog';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'mms.wamessagelog.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'mms.wamessagelog.view_layout';
