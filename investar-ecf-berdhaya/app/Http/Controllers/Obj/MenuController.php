...

{
    ...
    public function getIndex()
    {
        ...
        $this->data_url = 'obj/menu';

        $this->add_url = 'obj/menu/add';

        $this->update_url = 'obj/menu/edit';

        $this->del_url = 'obj/menu/del';

        $this->item_data_url = 'obj/menu/data';
        ...
        //$this->table_slot_view = 'obj.menu.tableslot';
