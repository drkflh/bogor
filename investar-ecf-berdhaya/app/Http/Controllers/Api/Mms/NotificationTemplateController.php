...
class NotificationTemplateController extends ApiAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'notification_template'; // name of yml ,ie: member.yml
        $this->entity = 'notificationtemplate';
