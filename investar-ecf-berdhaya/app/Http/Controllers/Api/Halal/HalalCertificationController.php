...
class HalalCertificationController extends ApiAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'halal_certification'; // name of yml ,ie: member.yml
        $this->entity = 'halalcertification';
