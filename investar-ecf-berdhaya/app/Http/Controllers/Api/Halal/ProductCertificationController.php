...
class ProductCertificationController extends ApiAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'productCertification'; // name of yml ,ie: member.yml
        $this->entity = 'productcertification';
