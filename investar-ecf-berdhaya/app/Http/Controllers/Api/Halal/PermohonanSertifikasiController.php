...
class PermohonanSertifikasiController extends ApiAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'permohonanSertifikasi'; // name of yml ,ie: member.yml
        $this->entity = 'permohonansertifikasi';
