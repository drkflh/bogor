...
class MedAdministeredDrugController extends ApiAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'fms_med_administered_drug'; // name of yml ,ie: member.yml
        $this->entity = 'medadministereddrug';
