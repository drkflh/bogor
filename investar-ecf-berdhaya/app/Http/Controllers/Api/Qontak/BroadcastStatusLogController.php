...
class BroadcastStatusLogController extends ApiAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'broadcast_status_log'; // name of yml ,ie: member.yml
        $this->entity = 'wabroadcaststatuslog';
