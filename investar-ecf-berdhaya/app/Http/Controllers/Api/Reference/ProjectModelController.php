...
use App\Models\Central\Project\Reference\ProjectModel;

class ProjectModelController extends ApiAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->yml_file = 'projectmodel'; // name of yml ,ie: member.yml
