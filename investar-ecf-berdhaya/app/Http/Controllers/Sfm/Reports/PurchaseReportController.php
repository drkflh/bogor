 ...
 * Time: 23.33
 */
namespace App\Http\Controllers\Sfm\Reports;
...

{
    public function __construct()
    {
        ...
        $this->res_path = 'models/controllers/sfm/reports';

        $this->yml_file = 'purchasereport_controller';

        $this->entity = 'Purchase Report';

        $this->auth_entity = 'sfm-reports-purchase-report';

        $this->controller_base = 'sfm/reports/purchase-report';

        $this->view_base = 'sfm.reports.purchasereport';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.reports.purchasereport.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.reports.purchasereport.view_layout';
