...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'inventoryreport_controller';

        $this->entity = 'Inventory Report';

        $this->auth_entity = 'sfm-reports-inventory-report';

        $this->controller_base = 'sfm/reports/inventory-report';

        $this->view_base = 'sfm.reports.inventoryreport';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.reports.inventoryreport.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.reports.inventoryreport.view_layout';
