...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'salesreport_controller';

        $this->entity = 'Sales Report';

        $this->auth_entity = 'sfm-reports-sales-report';

        $this->controller_base = 'sfm/reports/sales-report';

        $this->view_base = 'sfm.reports.salesreport';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.reports.salesreport.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.reports.salesreport.view_layout';
