...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'sfm-product-promo';

        $this->controller_base = 'sfm/product/promo';

        $this->view_base = 'sfm.product.promo';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.product.promo.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.product.promo.view_layout';
...
//        $this->defOrderDir = 'asc';
    ...
    public function beforeSave($data)
    {
        ...
        $data['periodStart'] = $data['period'][0];
        $data['periodEnd'] = $data['period'][1];
