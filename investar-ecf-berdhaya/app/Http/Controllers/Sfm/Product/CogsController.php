...
class CogsController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'cogs_controller';

        $this->entity = 'Cogs';

        $this->auth_entity = 'sfm-product-cogs';

        $this->controller_base = 'sfm/product/cogs';

        $this->view_base = 'sfm.product.cogs';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.product.cogs.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.product.cogs.view_layout';
