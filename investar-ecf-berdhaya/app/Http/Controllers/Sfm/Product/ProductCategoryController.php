 ...
 * Time: 23.33
 */
namespace App\Http\Controllers\Sfm\Product;
...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'sfm-product-product-category';

        $this->controller_base = 'sfm/product/product-category';

        $this->view_base = 'sfm.product.category';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.product.category.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.product.category.view_layout';
        ...
        $this->update_title_fields = '"<h4>'.__('Edit')." ".'" + this.category + "</h4>"';
        $this->view_title_fields = '"<h4>'.__('View')." ".'" + this.category + "</h4>"';
    ...
    public function setupFormOptions($formOptions, $data = null)
    {
        ...
        $formOptions['companyOptions'] = RefUtil::toOptions(RefUtil::getCompany(),'companyName','companyName', false);
    ...
    public function getEdit(Request $request, $id, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->title = __('Edit').' '.$item->category;
