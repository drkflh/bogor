...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'sfm-product-product-item';

        $this->controller_base = 'sfm/product/product-list';

        $this->view_base = 'sfm.product.product';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.product.product.form_layout';
        $this->form_dialog_size = 'xl';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.product.product.view_layout';
