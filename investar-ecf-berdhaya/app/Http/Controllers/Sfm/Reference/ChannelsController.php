...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'sfm-reference-channels';

        $this->controller_base = 'sfm/reference/channels';

        $this->view_base = 'sfm.reference.channels';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.reference.channels.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.reference.channels.view_layout';
