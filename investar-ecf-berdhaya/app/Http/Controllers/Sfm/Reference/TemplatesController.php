...
use App\Models\Sfm\Reference\Templates;
...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'sfm-reference-templates';

        $this->controller_base = 'sfm/reference/templates';

        $this->view_base = 'sfm.reference.templates';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.reference.templates.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.reference.templates.view_layout';
