 ...
 * Time: 23.33
 */
namespace App\Http\Controllers\Sfm\Reference;
...
use App\Models\Sfm\Reference\Outlets;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class OutletsController extends AdminController

{
    public function __construct()
    {
        ...
        $this->res_path = 'models/controllers/sfm/reference';

        $this->yml_file = 'outlets_controller';

        $this->entity = 'Outlets';

        $this->auth_entity = 'sfm-reference-outlets';

        $this->controller_base = 'sfm/reference/outlets';

        $this->view_base = 'sfm.reference.outlets';

        $this->model = new Outlets();
    }
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.reference.outlets.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.reference.outlets.view_layout';
