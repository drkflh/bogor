...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'sfm-reference-levels';

        $this->controller_base = 'sfm/reference/levels';

        $this->view_base = 'sfm.reference.levels';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.reference.levels.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.reference.levels.view_layout';
