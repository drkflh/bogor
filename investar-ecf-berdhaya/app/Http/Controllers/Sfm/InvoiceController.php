...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'sfm-transaction-invoice';

        $this->controller_base = 'sfm/invoice';

        $this->view_base = 'sfm.invoice';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.invoice.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.invoice.view_layout';
