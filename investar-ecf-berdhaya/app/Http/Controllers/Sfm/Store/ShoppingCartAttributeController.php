...

{
    public function __construct()
    {
        ...
        $this->controller_base = 'Sfm/Store/ShoppingCartAttribute';

        $this->view_base = 'sfm.store.shoppingcartattribute';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.store.shoppingcartattribute.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.store.shoppingcartattribute.view_layout';
