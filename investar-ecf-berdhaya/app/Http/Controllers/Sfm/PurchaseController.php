...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'sfm-transaction-purchase';

        $this->controller_base = 'Sfm/Purchase';

        $this->view_base = 'sfm.purchase';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'sfm.purchase.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'sfm.purchase.view_layout';
