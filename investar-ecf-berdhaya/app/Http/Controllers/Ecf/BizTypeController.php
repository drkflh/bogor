...
class BizTypeController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'biztype_controller';

        $this->entity = 'Jenis Usaha';

        $this->auth_entity = 'ecf-biz-type';

        $this->controller_base = 'ecf/biztype';

        $this->view_base = 'ecf.biztype';

        $this->title_fields = 'name';

        $this->model = new BizType();
    }
    ...
    public function getIndex()
    {
        ...
        $this->form_layout = 'ecf.biztype.form_layout';
        $this->form_dialog_size = 'md';

        /**
         * Set Viewer layout
         */
        $this->viewer_layout = 'ecf.biztype.view_layout';
