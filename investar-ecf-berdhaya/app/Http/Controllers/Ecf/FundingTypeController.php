...
class FundingTypeController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'fundingtype_controller';

        $this->entity = 'Jenis Pendanaan';

        $this->auth_entity = 'ecf-funding-type';

        $this->controller_base = 'ecf/fundingtype';

        $this->view_base = 'ecf.fundingtype';

        $this->title_fields = 'name';

        $this->model = new FundingType();
    }

    public function getIndex()
    {
        $this->title = 'Jenis Pendanaan';
        ...
        */
        ...
        $this->form_layout = 'ecf.fundingtype.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.fundingtype.view_layout';
