 ...
 * Time: 23.33
 */
namespace App\Http\Controllers\Ecf\Delivery;
...
use App\Models\Ecf\DeliveryOrder;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class DeliveryOrderController extends AdminController

{
    public function __construct()
    {
        ...
        $this->res_path = 'models/controllers/ecf/delivery';

        $this->yml_file = 'deliveryorder_controller';

        $this->entity = 'Delivery Order';

        $this->auth_entity = 'delivery-order';

        $this->controller_base = 'ecf/delivery/delivery-order';

        $this->view_base = 'ecf.delivery.deliveryorder';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.delivery.deliveryorder.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.delivery.deliveryorder.view_layout';
