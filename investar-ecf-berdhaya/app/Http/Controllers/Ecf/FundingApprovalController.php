...
use App\Models\Ecf\FundingRequest;
...

{
    public function __construct()
    {
        ...
        $this->controller_base = 'ecf/funding-approval';

        $this->view_base = 'ecf.fundingapproval';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.fundingapproval.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.fundingapproval.view_layout';
...
//        $this->defOrderDir = 'asc';
    ...
    public function additionalQuery($model, Request $request)
    {
        ...
        $model = $model->where('approvalStatus','=', 'AUDITED' );
        return $model;
    }
