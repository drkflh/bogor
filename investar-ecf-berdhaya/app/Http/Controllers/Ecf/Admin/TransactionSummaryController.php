...
class TransactionSummaryController extends AdminController
{
    public function __construct()
    {
        parent::__construct();

        $this->auth_entity = 'ecf-transaction-transaction-summary';
    ...
    public function getSummary($id = null){
        ...
        $this->yml_file = 'transactionsummary_controller';
        ...
        $this->form_layout = 'ecf.admin.dashboard.transactionsummary';
