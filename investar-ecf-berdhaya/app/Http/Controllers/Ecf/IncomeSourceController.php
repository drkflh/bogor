...
class IncomeSourceController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'incomesource_controller';

        $this->entity = 'Sumber Penghasilan';

        $this->auth_entity = 'ecf-income-source';

        $this->controller_base = 'ecf/incomesource';

        $this->view_base = 'ecf.incomesource';

        $this->title_fields = 'name';

        $this->model = new IncomeSource();
    }

    public function getIndex()
    {
        $this->title = 'Sumber Penghasilan';
        ...
        */
        ...
        $this->form_layout = 'ecf.incomesource.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.incomesource.view_layout';
