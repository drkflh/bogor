...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'expense_controller';

        $this->entity = 'Expense';

        $this->auth_entity = 'ecf-transaction-expense';

        $this->controller_base = 'Ecf/Expense';

        $this->view_base = 'ecf.expense';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.expense.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.expense.view_layout';
