...
class GetToKnowInvestarController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'gettoknowinvestar_controller';

        $this->entity = 'Mengetahui Investar';

        $this->auth_entity = 'ecf-know-investar';

        $this->controller_base = 'ecf/gettoknowinvestar';

        $this->view_base = 'ecf.gettoknowinvestar';

        $this->title_fields = 'name';

        $this->model = new GetToKnowInvestar();
    }

    public function getIndex()
    {
        $this->title = 'Mengetahui Investar';
        ...
        */
        ...
        $this->form_layout = 'ecf.gettoknowinvestar.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.gettoknowinvestar.view_layout';
