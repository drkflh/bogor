...
use App\Models\Ecf\Product\BillOfMaterial;
...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'ecf-product-bill-of-material';

        $this->controller_base = 'ecf/product/bill-of-material';

        $this->view_base = 'ecf.product.billofmaterial';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.product.billofmaterial.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.product.billofmaterial.view_layout';
