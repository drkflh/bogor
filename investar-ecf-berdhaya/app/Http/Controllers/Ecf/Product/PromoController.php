...
use App\Models\Ecf\Product\Promo;
...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'ecf-product-promo';

        $this->controller_base = 'ecf/product/promo';

        $this->view_base = 'ecf.product.promo';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.product.promo.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.product.promo.view_layout';
