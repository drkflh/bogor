...
use App\Models\Ecf\Product\Cogs;
...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'ecf-product-cogs';

        $this->controller_base = 'ecf/product/cogs';

        $this->view_base = 'ecf.product.cogs';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.product.cogs.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.product.cogs.view_layout';
