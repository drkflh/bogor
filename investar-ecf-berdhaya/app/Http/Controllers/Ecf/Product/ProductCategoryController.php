...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'ecf-product-product-category';

        $this->controller_base = 'ecf/product/product-category';

        $this->view_base = 'ecf.product.category';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.product.category.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.product.category.view_layout';
