...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'inventoryitem_controller';

        $this->entity = 'Buyer';

        $this->auth_entity = 'ecf-buyer';

        $this->controller_base = 'ecf/buyer';

        $this->view_base = 'ecf.buyer';

        $this->model = new InventoryItem();
        $this->model2 = new Campaign();
    }
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.pemodalinventory.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.pemodalinventory.view_layout';
        ...
        $this->table_component = 'grid-view-5';

        $this->grid_item_view = 'ecf.pemodalinventory.campaign_card';
    ...
    public function getViewForm($id)
    {
        ...
        $this->form_layout = 'ecf.pemodalinventory.campaign_buyer';
...
//        $this->defOrderDir = 'asc';
    ...
    public function additionalQuery($model, Request $request)
    {
        ...
        $model = Campaign::where('ownerId', '=', Auth::user()->_id );
        return $model;
    }
