...
class CitizenshipController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'citizenship_controller';

        $this->entity = 'Citizenship';

        $this->auth_entity = 'citizenship';

        $this->controller_base = 'ecf/citizenship';

        $this->view_base = 'ecf.citizenship';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.citizenship.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.citizenship.view_layout';
