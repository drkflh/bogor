...
use App\Models\Ecf\SponsorVoucherTrx;
...

{
    public function __construct()
    {
        ...
        $this->controller_base = 'ecf/sponsor-voucher-trx';

        $this->view_base = 'ecf.sponsorvouchertrx';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.sponsorvouchertrx.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.sponsorvouchertrx.view_layout';
