...
class PositionInCompanyController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'positionincompany_controller';

        $this->entity = 'PIC';

        $this->auth_entity = 'ecf-positionincompany';

        $this->controller_base = 'ecf/positionincompany';

        $this->view_base = 'ecf.positionincompany';

        $this->title_fields = 'name';

        $this->model = new PositionInCompany();
    }
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.positionincompany.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.positionincompany.view_layout';
