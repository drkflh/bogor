...
use App\Models\Ecf\SalesOperation\JobRegister;
use App\Models\Ecf\SalesOperation\SalesHighlight;
use Carbon\Carbon;
use DateInterval;
use DatePeriod;
use DateTime;
...
class ProductSummaryController extends AdminController
{
    public function __construct()
    {
        ...
        $this->auth_entity = 'ecf-product-product-summary';
    ...
    public function getSummary($id = null){
        ...
        $this->form_layout = 'ecf.admin.dashboard.productsummary';
