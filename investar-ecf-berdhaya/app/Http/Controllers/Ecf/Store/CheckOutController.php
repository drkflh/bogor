...

{
    public function __construct()
    {
        ...
        $this->view_base = 'ecf.store.checkout';
    ...
    public function getShopping($id = null){
        ...
        $this->item_data_url = 'ecf/checkout/data';
        ...
        $this->form_layout = 'ecf.checkout.form_layout';
    ...
    public function getAdd(Request $request, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->form_layout = 'ecf.shoppingcart.form_layout';
