...
class ShoppingCartAttributeController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'shoppingcartattribute_controller';

        $this->entity = 'Shopping Cart Attribute';

        $this->auth_entity = 'shopping-cart-attribute';

        $this->controller_base = 'Ecf/Store/ShoppingCartAttribute';

        $this->view_base = 'ecf.store.shoppingcartattribute';
    ...
    {
        $this->title = 'Shopping Cart Attribute';
        ...
        */
        ...
        $this->form_layout = 'ecf.store.shoppingcartattribute.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.store.shoppingcartattribute.view_layout';
