...

{
    public function __construct()
    {
        ...
        $this->view_base = 'ecf.store.shoppingcart';
    ...
    public function getIndex()
    {
        ...
        //  * Set Viewer layout
        //  */
        // // $this->viewer_layout = 'ecf.shoppingcart.view_layout';
    ...
    public function getList(Request $request, $keyword0, $keyword1 = null, $keyword2 = null)
    {
         ...
         * Set Viewer layout
         */
        $this->viewer_layout = 'ecf.store.shoppingcart.view_layout';
        $this->viewer_dialog_size = 'xl';
    ...
    public function clearItem($id){
        ...
        // print_r($id);
        return redirect( url('ecf/shoppingcart'));
    }
    public function clearShoppingCart(){
        ...
        // print_r($result);
        return redirect( url('ecf/etalase'));
    }
    ...
    public function getData($id, $additional_data = null)
    {
        ...
        $population['subTotal'] = ShoppingCart::select('pricePerLot')->where('cartSession','=',$cartSession)->sum('orderSubTotal');
    ...
    // // print_r($attributes);
        ...
        $population['total'] = $population['subTotal'] ;
        $population['mobile'] = $attributes["mobile"];
        $population['email'] = $attributes["email"];
        // $population['campaignId'] = $attributes["campaignId"];


        $population['buyer'] = $attributes["buyer"];
        $population['orderID'] = "ECF-".$cartSession;
        $population['orderDate'] = Carbon::now()->isoFormat('DD MM YYYY');;

        $br = ShoppingCart::select('orderQty','pricePerLot','campaignTitle', 'unitPerLot', 'campaignId' )
        ...
        foreach($datatable as $databaru){
            $databaru["total"] = $databaru["orderQty"] * $databaru["pricePerLot"];
        }
