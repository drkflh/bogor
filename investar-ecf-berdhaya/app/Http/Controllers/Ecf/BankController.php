...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'bank_controller';

        $this->entity = 'Bank';

        $this->auth_entity = 'ecf-bank';

        $this->controller_base = 'ecf/bank';

        $this->view_base = 'ecf.bank';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.bank.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.bank.view_layout';
