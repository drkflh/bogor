...

{
    public function __construct()
    {
        ...
        $this->controller_base = 'ecf/funding-draft';

        $this->view_base = 'ecf.fundingrequest';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.fundingrequest.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.fundingrequest.view_layout';
...
//        $this->defOrderDir = 'asc';
    ...
    public function additionalQuery($model, Request $request)
    {
        ...
        $model = $model->where('approvalStatus','=', 'OPEN' );
        return $model;
    }
