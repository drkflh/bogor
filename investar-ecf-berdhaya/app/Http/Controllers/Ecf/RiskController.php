...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'risk_controller';

        $this->entity = 'Resiko';

        $this->auth_entity = 'ecf-risk';

        $this->controller_base = 'ecf/risk';

        $this->view_base = 'ecf.risk';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.risk.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.risk.view_layout';
