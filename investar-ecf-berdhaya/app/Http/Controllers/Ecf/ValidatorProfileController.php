...
use App\Models\Ecf\ValidatorProfile;
...

{
    public function __construct()
    {
        ...
        $this->controller_base = 'ecf/validator-profile';

        $this->view_base = 'ecf.validatorprofile';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.validatorprofile.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.validatorprofile.view_layout';
