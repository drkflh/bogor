...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'purchase_controller';

        $this->entity = 'Purchase';

        $this->auth_entity = 'ecf-transaction-purchase';

        $this->controller_base = 'Ecf/Purchase';

        $this->view_base = 'ecf.purchase';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.purchase.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.purchase.view_layout';
