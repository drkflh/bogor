...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'ecf-directory-vendor-directory';

        $this->controller_base = 'ecf/directory/vendor-directory';

        $this->view_base = 'ecf.directory.vendordirectory';
    ...
    public function getIndex()
    {
        ...
        $this->viewer_layout = 'ecf.directory.vendordirectory.view_layout';

        /* Use custom form layout */
        $this->form_view = 'form.html'; // use plain html
        $this->form_layout = 'ecf/directory/vendordirectory/formlayout';
      ...
      ->setObjFields( // mwnambahkan setting field untuk table
        ...
        ->setObjTemplate(view('ecf.directory.vendordirectory.contact')->render() ) // set template
