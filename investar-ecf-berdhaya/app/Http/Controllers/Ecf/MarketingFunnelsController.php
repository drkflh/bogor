...
class MarketingFunnelsController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'marketingfunnels_controller';

        $this->entity = 'Jalur Pemasaran';

        $this->auth_entity = 'ecf-marketing-funnels';

        $this->controller_base = 'ecf/marketingfunnels';

        $this->view_base = 'ecf.marketingfunnels';

        $this->title_fields = 'name';

        $this->model = new MarketingFunnels();
    }

    public function getIndex()
    {
        $this->title = 'Jalur Pemasaran';
        ...
        */
        ...
        $this->form_layout = 'ecf.marketingfunnels.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.marketingfunnels.view_layout';
