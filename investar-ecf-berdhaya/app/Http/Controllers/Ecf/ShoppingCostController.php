...
use App\Models\Ecf\ShoppingCost;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class ShoppingCostController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'shoppingcost_controller';

        $this->entity = 'Shopping Cost';

        $this->auth_entity = 'shopping-cost';

        $this->controller_base = 'ecf/shopping-cost';

        $this->view_base = 'ecf.shoppingcost';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.shoppingcost.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.shoppingcost.view_layout';
...
//        $this->defOrderDir = 'asc';
    ...
    public function beforeSave($data)
    {
        ...
        $data['weightCostUnit'] = (int)$data['weightCostUnit'];
        $data['minWeight'] = (int)$data['minWeight'];
        $data['maxWeight'] = (int)$data['maxWeight'];
