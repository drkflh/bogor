...
class CurrentJobController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'currentjob_controller';

        $this->entity = 'Pekerjaan';

        $this->auth_entity = 'ecf-current-job';

        $this->controller_base = 'ecf/currentjob';

        $this->view_base = 'ecf.currentjob';

        $this->title_fields = 'name';

        $this->model = new CurrentJob();
    }
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.currentjob.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.currentjob.view_layout';
