...

{
    public function __construct()
    {
        ...
        $this->controller_base = 'ecf/shopping-cart';

        $this->view_base = 'ecf.shoppingcart';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->table_component = 'grid-view-2';

        $this->grid_item_view = 'ecf.shoppingcart.product_card';
    ...
    public function getShopping($id = null){
        ...
        $this->item_data_url = 'shopping/data';
    ...
    if(isset($attributes['delivery_option'])){
        ...
        $br = ShoppingCart::select('orderQty','price','campaignTitle','productCode' )
...
//            ->groupBy('campaignTitle')
    ...
    public function getModel($data, $model)
    {
        ...
        $newmodel = $tmodel->where('cartSession', '=', (Auth::user()->cartSession ?? 'nosession') )
            ->where('campaignTitle', '=', $data['campaignTitle'])
            ->first();
...
//            $cg[ $cd['campaignTitle'] ] = $cd;
//            $cg[ $cd['campaignTitle'] ]['orderQty'] += $cd['orderQty'] ?? 0;
//            $cg[ $cd['campaignTitle'] ]['orderSubTotal'] += $cd['orderSubTotal'] ?? 0;
//            $total += $cg[ $cd['campaignTitle'] ]['orderSubTotal'];
//        }
//
