...
use App\Models\Ecf\Reference\Levels;
...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'levels_controller';

        $this->entity = 'Levels';

        $this->auth_entity = 'ecf-reference-levels';

        $this->controller_base = 'ecf/reference/levels';

        $this->view_base = 'ecf.reference.levels';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.reference.levels.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.reference.levels.view_layout';
