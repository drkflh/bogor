...
use App\Models\Ecf\Reference\Channels;
...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'channels_controller';

        $this->entity = 'Channels';

        $this->auth_entity = 'ecf-reference-channels';

        $this->controller_base = 'ecf/reference/channels';

        $this->view_base = 'ecf.reference.channels';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.reference.channels.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.reference.channels.view_layout';
