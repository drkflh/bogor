 ...
 * Time: 23.33
 */
namespace App\Http\Controllers\Ecf\Reference;
...
use App\Models\Ecf\Reference\Outlets;
...

{
    public function __construct()
    {
        ...
        $this->res_path = 'models/controllers/ecf/reference';

        $this->yml_file = 'outlets_controller';

        $this->entity = 'Outlets';

        $this->auth_entity = 'ecf-reference-outlets';

        $this->controller_base = 'ecf/reference/outlets';

        $this->view_base = 'ecf.reference.outlets';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.reference.outlets.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.reference.outlets.view_layout';
