...
use App\Models\Ecf\Reference\Templates;
...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'templates_controller';

        $this->entity = 'Templates';

        $this->auth_entity = 'ecf-reference-templates';

        $this->controller_base = 'ecf/reference/templates';

        $this->view_base = 'ecf.reference.templates';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.reference.templates.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.reference.templates.view_layout';
