...
class RelativeRelationController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'relativerelation_controller';

        $this->entity = 'Hubungan Orang Terdekat';

        $this->auth_entity = 'ecf-relative-relation';

        $this->controller_base = 'ecf/relativerelation';

        $this->view_base = 'ecf.relativerelation';

        $this->title_fields = 'name';

        $this->model = new RelativeRelation();
    }

    public function getIndex()
    {
        $this->title = 'Hubungan Orang Terdekat';
        ...
        */
        ...
        $this->form_layout = 'ecf.relativerelation.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.relativerelation.view_layout';
