...
class InvestorTypeController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'investortype_controller';

        $this->entity = 'Tipe Investor';

        $this->auth_entity = 'ecf-investor-type';

        $this->controller_base = 'ecf/investortype';

        $this->view_base = 'ecf.investortype';

        $this->title_fields = 'name';

        $this->model = new InvestorType();
    }

    public function getIndex()
    {
        $this->title = 'Tipe Investor';
        ...
        */
        ...
        $this->form_layout = 'ecf.investortype.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.investortype.view_layout';
