...
class MonthlyIncomeController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'monthlyincome_controller';

        $this->entity = 'Penghasilan Perbulan';

        $this->auth_entity = 'ecf-monthly-income';

        $this->controller_base = 'ecf/monthlyincome';

        $this->view_base = 'ecf.monthlyincome';
    ...
    {
        $this->title = 'Penghasilan Perbulan';
        ...
        */
        ...
        $this->form_layout = 'ecf.monthlyincome.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.monthlyincome.view_layout';
