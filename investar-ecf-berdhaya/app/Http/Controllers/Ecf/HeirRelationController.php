...
class HeirRelationController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'heirrelation_controller';

        $this->entity = 'Hubungan Ahli Waris';

        $this->auth_entity = 'ecf-heir-relation';

        $this->controller_base = 'ecf/heirrelation';

        $this->view_base = 'ecf.heirrelation';

        $this->title_fields = 'name';

        $this->model = new HeirRelation();
    }

    public function getIndex()
    {
        $this->title = 'Hubungan Ahli Waris';
        ...
        */
        ...
        $this->form_layout = 'ecf.heirrelation.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.heirrelation.view_layout';
