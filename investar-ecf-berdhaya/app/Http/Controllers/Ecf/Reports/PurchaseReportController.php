 ...
 * Time: 23.33
 */
namespace App\Http\Controllers\Ecf\Reports;
...
use App\Models\Ecf\Reports\PurchaseReport;
...

{
    public function __construct()
    {
        ...
        $this->res_path = 'models/controllers/ecf/reports';

        $this->yml_file = 'purchasereport_controller';

        $this->entity = 'Purchase Report';

        $this->auth_entity = 'ecf-reports-purchase-report';

        $this->controller_base = 'ecf/reports/purchase-report';

        $this->view_base = 'ecf.reports.purchasereport';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.reports.purchasereport.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.reports.purchasereport.view_layout';
