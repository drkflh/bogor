...
class LastEducationController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'lasteducation_controller';

        $this->entity = 'Pendidikan Terakhir';

        $this->auth_entity = 'ecf-last-education';

        $this->controller_base = 'ecf/lasteducation';

        $this->view_base = 'ecf.lasteducation';

        $this->title_fields = 'name';

        $this->model = new LastEducation();
    }

    public function getIndex()
    {
        $this->title = 'Pendidikan Terakhir';
        ...
        */
        ...
        $this->form_layout = 'ecf.lasteducation.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.lasteducation.view_layout';
