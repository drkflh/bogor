...

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'ecf-transaction-payment';

        $this->controller_base = 'Ecf/Payment';

        $this->view_base = 'ecf.payment';
    ...
    public function getIndex()
    {
        ...
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.payment.view_layout';
