...
use App\Models\Ecf\SponsorDeposit;
use App\Models\Core\Mongo\User;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class SponsorDepositController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'sponsordeposit_controller';

        $this->entity = 'Sponsor Deposit';

        $this->auth_entity = 'sponsor-deposit';

        $this->controller_base = 'ecf/sponsor-deposit';

        $this->view_base = 'ecf.sponsordeposit';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.sponsordeposit.form_layout';
        $this->form_dialog_size = 'lg';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.sponsordeposit.view_layout';
