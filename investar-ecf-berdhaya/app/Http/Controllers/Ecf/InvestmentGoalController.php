...
class InvestmentGoalController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'investmentgoal_controller';

        $this->entity = 'Tujuan Investasi';

        $this->auth_entity = 'ecf-investment-goal';

        $this->controller_base = 'ecf/investmentgoal';

        $this->view_base = 'ecf.investmentgoal';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.investmentgoal.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.investmentgoal.view_layout';
