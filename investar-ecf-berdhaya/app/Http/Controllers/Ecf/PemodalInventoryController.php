...
class PemodalInventoryController extends AdminController

{
    public function __construct()
    {
        ...
        $this->auth_entity = 'ecf-pemodalinventory';

        $this->controller_base = 'ecf/inventorypemodal';

        $this->view_base = 'ecf.pemodalinventory';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->table_component = 'grid-view-3';

        $this->grid_item_view = 'ecf.pemodalinventory.product_card';
