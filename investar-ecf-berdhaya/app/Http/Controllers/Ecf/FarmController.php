...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'farm_controller';

        $this->entity = 'Farm';

        $this->auth_entity = 'ecf-farm-register';

        $this->controller_base = 'ecf/farm-register';

        $this->view_base = 'ecf.farm';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.farm.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.farm.view_layout';
        ...
        $this->print_template = 'farm-profile';

        $this->add_as_page = false;
        $this->edit_as_page = false;

        $this->title_fields = 'farmId';
        $this->pdf_title_fields = 'farmId';
    ...
    public function getAdd(Request $request, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->page_methods_view = 'ecf.farm.add_methods';
        $this->page_computed_view = 'ecf.farm.add_computed';
        $this->page_watch_view = 'ecf.farm.add_watch';
    ...
    public function getEdit(Request $request, $id, $keyword0 = null, $keyword1 = null, $keyword2 = null)
    {
        ...
        $this->title = __('Edit').' '.$obj->farmName;
        ...
        $this->page_methods_view = 'ecf.farm.edit_methods';
        $this->page_computed_view = 'ecf.farm.edit_computed';
        $this->page_watch_view = 'ecf.farm.edit_watch';
    ...
    {
        $geoFenceTemplate = "'".view('ecf.farm.geofence')->render()."'" ;
    ...
    {
        if( is_null($data['farmId']) || $data['farmId'] == ''  ){
