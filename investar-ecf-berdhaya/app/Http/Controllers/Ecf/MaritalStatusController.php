...

{
    public function __construct()
    {
        ...
        $this->yml_file = 'maritalstatus_controller';

        $this->entity = 'Status Pernikahan';

        $this->auth_entity = 'ecf-marital-status';

        $this->controller_base = 'ecf/maritalstatus';

        $this->view_base = 'ecf.maritalstatus';
    ...
    public function getIndex()
    {
        ...
        */
        ...
        $this->form_layout = 'ecf.maritalstatus.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.maritalstatus.view_layout';
