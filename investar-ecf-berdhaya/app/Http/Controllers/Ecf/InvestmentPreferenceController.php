...
class InvestmentPreferenceController extends AdminController

{
    public function __construct()
    {
        ...
        $this->yml_file = 'investmentpreference_controller';

        $this->entity = 'Preferensi Investasi';

        $this->auth_entity = 'ecf-investment-preference';

        $this->controller_base = 'ecf/investmentpreference';

        $this->view_base = 'ecf.investmentpreference';

        $this->title_fields = 'name';

        $this->model = new InvestmentPreference();
    }
    ...
    public function getIndex()
    {
        ...
        $this->title = 'Preferensi Investasi';
        ...
        */
        ...
        $this->form_layout = 'ecf.investmentpreference.form_layout';
        $this->form_dialog_size = 'md';

        /**
        * Set Viewer layout
        */
        $this->viewer_layout = 'ecf.investmentpreference.view_layout';
