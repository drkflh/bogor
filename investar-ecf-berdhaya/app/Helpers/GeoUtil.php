...
class GeoUtil{
    ...
    public static function getDistance($from, $to, $unit, $algo){
        $geotools = new \League\Geotools\Geotools();
        $coordA   = new \League\Geotools\Coordinate\Coordinate($from);
        $coordB   = new \League\Geotools\Coordinate\Coordinate($to);

        $dist = $geotools->distance()->setFrom($coordA)->setTo($coordB);

        $distance = $dist->in($unit)->{$algo}();
