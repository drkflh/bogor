...
window.appwrite = new Appwrite();
Vue.prototype.appwrite = new Appwrite();
...
import { DatePicker, AutoComplete, Tooltip, Table, Spin, Calendar, Select, List, Timeline, Avatar, ConfigProvider, TreeSelect } from 'ant-design-vue';
Vue.use(DatePicker);
...
Vue.component('form-runner', require('./components/dcs/FormRunner.vue').default);
...
Vue.component('auto-user', require('./components/AutoUser.vue').default);
...
Vue.component('horizontal-timeline', require('./components/HorizontalTimeline.vue').default);
...
Vue.component('button-approval-pin-ajax', require('./components/ButtonApprovalPinAjax.vue').default);
Vue.component('button-single-approval-pin-ajax', require('./components/ButtonSingleApprovalPinAjax.vue').default);

Vue.component('signature-card-upload', require('./components/SignatureCardUpload.vue').default);
...
Vue.component('dms-active-form', require('./components/DmsActiveForm.vue').default);
Vue.component('dms-fixed-form', require('./components/DmsFixedForm.vue').default);
