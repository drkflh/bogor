<template>
    <div>
        <div style="clear: both;display: block;">
            <div style="display: block;position:relative;height:150px;width: 150px;min-height: 150px;top: 0;left: 0;margin: auto;">
                <img  :src="value" @click="showLightBox( 0 )"
                      @error="setAltImg"
                      style="height:145px;width: 145px; object-fit: cover; border-radius: 6px;border: thin solid lightgray;" >
                    <vue-clip
                        :on-sending="sending"
...
<script>
    export default {
        ...
        props: {
            value: {
                type: String,
                default: 'images/default_256_user.jpg'
            },
            uploadurl : {
                type: String,
