                ...
                <div class="col-lg-5">
                    <div class="border p-40 cart-totals ml-30 mb-50">
                        ...
                        <div class="table-responsive order_table checkout">
                            {!! $tableCart ?? '' !!}
                            <h4>Sub Total :  <span class="text-brand">@{{ currency.currency }}. @{{ subTotal }}</span></h4>
                            <h4>Weight :  @{{ weight }} Gram</h4>
                    ...
                    <div class="payment ml-30">
                        ...
                        <button  type="submit" class="btn text-light btn-fill-out btn-block mt-30">Place an Order<i class="fi-rs-sign-out ml-15"></i></button>
                    </div>
                </div>
            </div>
</form>
