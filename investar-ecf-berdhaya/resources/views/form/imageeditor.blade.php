            ...
            <div class="tui-image-editor-controls">
                <ul class="menu">
                    <li class="menu-item  btn btn-primary input-wrapper">
                        <i class="las la-folder-open"></i> Load
                        <input type="file" accept="image/*" id="input-image-file">
                    </li>
                    <li class="menu-item btn btn-primary" id="btn-download"><i class="las la-save"></i> Save</li>
                    <li class="menu-item btn btn-secondary" id="btn-undo"><i class="las la-undo"></i> Undo</li>
                    <li class="menu-item btn btn-secondary disabled" id="btn-redo"><i class="las la-redo"></i> Redo</li>
                    <li class="menu-item btn btn-secondary" id="btn-clear-objects"><i class="las la-trash"></i> Clear All</li>
                    <li class="menu-item btn btn-secondary" id="btn-remove-active-object"><i class="las la-remove"></i> Remove Object</li>
                    <li class="menu-item btn btn-secondary" id="btn-crop"><i class="las la-crop"></i> Crop</li>
                    <li class="menu-item btn btn-secondary" id="btn-flip"><i class="las la-"></i> Flip</li>
                    <li class="menu-item btn btn-secondary" id="btn-rotation"><i class="las la-sync"></i> Rotation</li>
                    <li class="menu-item btn btn-secondary" id="btn-draw-line"><i class="las la-pencil-alt"></i> Draw</li>
                    <li class="menu-item btn btn-secondary" id="btn-draw-shape"><i class="las la-draw-polygon"></i> Shape</li>
                    <li class="menu-item btn btn-secondary" id="btn-add-icon"><i class="las la-picture-o"></i> Icon</li>
                    <li class="menu-item btn btn-secondary" id="btn-text"><i class="las la-font"></i> Text</li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12" >
                        ...
                        <div class="sub-menu-container" id="rotation-sub-menu" style="display: none;">
                            <ul class="vertical-menu">
                                <li class="menu-item btn btn-secondary" id="btn-rotate-clockwise"><i class="las la-rotate-left"></i> 30 deg</li>
                                <li class="menu-item btn btn-secondary" id="btn-rotate-counter-clockwise"><i class="las la-rotate-right"></i> -30 deg</li>
                        ...
                        <div class="sub-menu-container" id="text-sub-menu">
                            <ul class="menu">
                                <li class="menu-item"><button class="btn-text-style btn btn-secondary" data-style-type="b"><i class="las la-bold"></i></button></li>
                                <li class="menu-item"><button class="btn-text-style btn btn-secondary" data-style-type="i"><i class="las la-italic"></i></button></li>
                                <li class="menu-item"><button class="btn-text-style btn btn-secondary" data-style-type="u"><i class="las la-underline"></i></button></li>
                                <li class="menu-item"><button class="btn-text-style btn btn-secondary" data-style-type="l"><i class="las la-align-left"></i></button></li>
                                <li class="menu-item"><button class="btn-text-style btn btn-secondary" data-style-type="c"><i class="las la-align-center"></i></button></li>
                                <li class="menu-item"><button class="btn-text-style btn btn-secondary" data-style-type="r"><i class="las la-align-right"></i></button></li>
