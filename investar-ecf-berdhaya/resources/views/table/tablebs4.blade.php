            ...
            data: function() {
                return {
                    ...
                    actions: [
                        @if($can_add)
                        {
                            btn_text: '<i class="las la-plus"></i> Add {{ Str::singular($title) }}',
                            event_name: "on-add",
                        ...
                        @if($can_multi_delete)
                        {
                            btn_text: '<i class="las la-trash"></i> Multi Delete',
                            ...
                            <div>
                                @if($show_actions)
                                    <b-dropdown dropright variant="border-transparent" no-caret >
                                        ...
                                        <b-dropdown-item href="#" @click="showViewModal(props.row)" ><i class="las la-eye"></i> View</b-dropdown-item>
                                        <b-dropdown-item href="#" @click="showUpdateModal(props.row)" ><i class="las la-edit"></i> Edit</b-dropdown-item>
                                        <b-dropdown-divider></b-dropdown-divider>
                                        <b-dropdown-item href="#" @click="showCloneModal(props.row)" ><i class="las la-copy"></i> Clone</b-dropdown-item>
                                        <b-dropdown-divider></b-dropdown-divider>
                                        <b-dropdown-item href="#" @click="showDeleteModal(props.row)" ><i class="las la-trash"></i> Delete</b-dropdown-item>
                                    </b-dropdown>
                                @endif
                            </div>
                        </template>
