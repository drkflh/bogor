...
<html lang="en" class="no-js">
    ...
    <body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="60">
        ...
        {{-- Hero--}}
        {!! \App\Helpers\CmsUtil::singleBlock( \App\Helpers\CmsUtil::getArticleBySlug('home-hero'), 'home1hero', 'dojek' ) !!}
 
        {{-- Campaign--}}
        <?php
            $content = \App\Models\Ecf\Campaign::where('campaignStatus', 'VERIFIED')->get();
            // echo $content;
