...
<head>
    ...
    <link rel="stylesheet" href="{{ url('public/bootstrap-4.6.1-dist/css/bootstrap.min.css') }}">
...
{{--    <link href="//db.onlinewebfonts.com/c/a78cfad3beb089a6ce86d4e280fa270b?family=Calibri" rel="stylesheet" type="text/css"/>--}}
    ...
    <style>
        ...
        @page  {
            ...
            @if(in_array('With Page Number', $numberSetting) )
                @if($numberPosition == 'Right')
                    @bottom-right {
                        font-family: Calibri, Overpass,sans-serif;
                        font-weight: normal;
                        font-size: 8pt;
        ...
        .footerRight{
            ...
            text-align: right;
            font-size:8pt;
            font-family: Calibri, Overpass, -apple-system, system-ui, BlinkMacSystemFont, Arial;
        }
