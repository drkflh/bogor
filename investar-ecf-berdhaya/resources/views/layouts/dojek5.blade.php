        ...
        <section class="hero-5" id="home">
           <div class="container">
               <div class="row align-items-center justify-content-center">
                   <div class="col-lg-6">
                       <h1 class="mb-4 display-5 fw-semibold">Here is the best way to present your apps</h1>
                       <p class="text-muted fs-17">Itaque earum rerum hic tenetur a sapiente delectus ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis as that doloribuseds asperiores repellat.</p>
                       <a href="{{ url('themes/dojek') }}/javascript:void(0);" class="btn btn-lg btn-gradient-success mt-4 mb-4 mb-lg-0">Learn More <i class="mdi mdi-arrow-right fs-14 ms-1"></i></a>
                   </div>

                   <div class="col-md-8 col-lg-5 offset-lg-1">
                      <div class="card mb-0">
                          <div class="card-body p-4">
                            <h5 class="border-bottom fs-22 pb-3 mb-4">Register For Free</h5>

                            <div class="mb-3">
                                <label for="formFullname" class="form-label text-muted fs-14">Full Name <span class="text-danger">*</span></label>
                                <input type="email" class="form-control" id="formFullname" placeholder="Name...">
                            </div>
                            <div class="mb-3">
                                <label for="formEmail" class="form-label text-muted fs-14">Email Address <span class="text-danger">*</span></label>
                                <input type="email" class="form-control" id="formEmail" placeholder="Email...">
                            </div>
                            <div class="mb-3">
                                <label for="formUsername" class="form-label text-muted fs-14">User Name <span class="text-danger">*</span></label>
                                <input type="email" class="form-control" id="formUsername" placeholder="User Name...">
                            </div>
                            <div class="mb-4">
                                <label for="formPassword" class="form-label text-muted fs-14">Password <span class="text-danger">*</span></label>
