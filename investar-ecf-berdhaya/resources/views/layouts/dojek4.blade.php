           ...
           <div class="container">
               <div class="row justify-content-center">
                   <div class="col-md-10 col-lg-9 col-xl-7">
                       <div class="text-center hero-4-content">
                             <h1 class="display-4 fw-semibold hero-title mb-3">Dojek Design Agency</h1>
                             <p class="text-muted fs-17 mb-4 pb-2">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates that is repudiandae.</p>
                             <a href="{{ url('themes/dojek') }}/javascript:void(0);" class="btn btn-primary">Learn More <i class="mdi mdi-arrow-right-thin ms-1"></i></a>
                       </div>
                   </div>
               </div>
           </div>
               ...
               <div class="row">
                   <div class="col-12">
                       <div class="hero-bottom-shape">
                           <img src="{{ url('themes/dojek') }}/images/heros/hero-4-bottom.png" alt="" class="w-100">
                       </div>
                   </div>
               </div>
           </div>
