                            ...
                            <div class="row d-flex justify-content-md-end justify-content-sm-center" style="background-color: transparent;margin: 0px !important;">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-7 col-xs-12 pl-md-0"
                                    ...
                                    <div class="auth-form-wrapper px-4 py-5">
                                        ...
                                        @endif
                                        <form action="{{ url('pass/reset/'.$session) }}" method="post">
                                            @csrf
                                            <input type="hidden" name="session" value="{{ $session }}" />
                                            <div class="form-group row">
                                                <label for="password"
                                                       class="col-md-5 col-form-label text-md-right">{{ __('New Password') }}</label>
                                            ...
                                            <div class="form-group row">
                                                <label for="password-confirm"
                                                       class="col-md-5 col-form-label text-md-right">{{ __('Confirm New Password') }}</label>
