            ...
            infobarvm = new Vue({
                ...
                data: function(){
                    return {
                        ...
                        infoDefault: {!! json_encode( $info_topbar_template ?? new ArrayObject() ) !!},
                        infoContent: {!! json_encode( $info_topbar_data ?? new ArrayObject() ) !!},
                        infoParams: {!! json_encode( $info_topbar_params ?? new ArrayObject() ) !!},
                        infoTemplate: {!! is_array($right_sidebar_template)? json_encode($right_sidebar_template) : $right_sidebar_template !!},
                    @if($info_topbar_show)
                        topBarShow: true,
                    @else
                        topBarShow: false,
        ...
        <div class="content-header">
            ...
            <div class="content-header-section" id="top-overlay"  >
                ...
                @if($info_topbar_show)
                    ...
                    @include('partials.app.kmn.codebase.topinfobar')
                ...
                @if($info_topbar_show)
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown" data-toggle="layout" data-action="side_overlay_toggle">
                            <i class="las la-plus-circle"></i> <span class="d-none d-sm-inline-block">Data Tambahan</span>
                        </button>
                    </div>
                @endif

                {{--<button type="button" class="btn btn-dual-secondary" data-toggle="layout" data-action="side_overlay_toggle">--}}
                    {{--<i class="las la-2x fa-info-circle"></i> Data Tambahan--}}
                {{--</button>--}}
