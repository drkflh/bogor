        ...
        <div class="content-side">
            ...
            <div class="block pull-r-l">
                <div class="block-header bg-body-light">
                    <h3 class="block-title"><i class="las la-fw fa-users font-size-default mr-5"></i>Friends</h3>
                    ...
                    <ul class="nav-users push">
                        <li>
                            <a href="be_pages_generic_profile.html">
                                ...
                                <i class="las la-circle text-success"></i> Amber Harvey
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                ...
                                <i class="las la-circle text-success"></i> Ryan Flores
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="{{ url('themes/codebase') }}/assets/media/avatars/avatar6.jpg" alt="">
                                <i class="las la-circle text-warning"></i> Andrea Gardner
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                ...
                                <i class="las la-circle text-danger"></i> Wayne Garcia
            ...
            <div class="block pull-r-l">
                <div class="block-header bg-body-light">
                    <h3 class="block-title">
                        <i class="las la-fw fa-clock-o font-size-default mr-5"></i>Activity
                    </h3>
                    <div class="block-options">
                        <button type="button" class="btn-block-option" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo">
                            <i class="si si-refresh"></i>
                        ...
                        <li>
                            ...
                            <div>
                                <a href="javascript:void(0)">
                                    <i class="las la-file-text-o"></i> Docs.doc
                                </a>
                            </div>
            ...
            <div class="block pull-r-l">
                <div class="block-header bg-body-light">
                    <h3 class="block-title">
                        <i class="las la-fw fa-pencil font-size-default mr-5"></i>Profile
                    </h3>
                    <div class="block-options">
                        <button type="button" class="btn-block-option" data-toggle="block-option" data-action="content_toggle"></button>
                    </div>
                        ...
                        <div class="form-group row">
                            <div class="col-6">
                                <button type="submit" class="btn btn-block btn-alt-primary">
                                    <i class="las la-refresh mr-5"></i> Update
                                </button>
                            </div>
                        </div>
                    </form>
            ...
            <div class="block pull-r-l">
                <div class="block-header bg-body-light">
                    <h3 class="block-title">
                        <i class="las la-fw fa-wrench font-size-default mr-5"></i>Settings
                    </h3>
                    <div class="block-options">
                        <button type="button" class="btn-block-option" data-toggle="block-option" data-action="content_toggle"></button>
                    </div>
    ...
    <header id="page-header">
                    ...
                    <div class="dropdown-menu dropdown-menu-left min-width-300" aria-labelledby="page-header-notifications">
                        ...
                        <ul class="list-unstyled my-20">
                            <li>
                                <a class="text-body-color-dark media mb-15" href="javascript:void(0)">
                                    <div class="ml-5 mr-15">
                                        <i class="las la-fw fa-check text-success"></i>
                                    </div>
                            ...
                            <li>
                                <a class="text-body-color-dark media mb-15" href="javascript:void(0)">
                                    <div class="ml-5 mr-15">
                                        <i class="las la-fw fa-exclamation-triangle text-warning"></i>
                                    </div>
                                    <div class="media-body pr-10">
                            ...
                            <li>
                                <a class="text-body-color-dark media mb-15" href="javascript:void(0)">
                                    <div class="ml-5 mr-15">
                                        <i class="las la-fw fa-times text-danger"></i>
                                    </div>
                                    <div class="media-body pr-10">
                            ...
                            <li>
                                <a class="text-body-color-dark media mb-15" href="javascript:void(0)">
                                    <div class="ml-5 mr-15">
                                        <i class="las la-fw fa-plus text-primary"></i>
                                    </div>
                                    <div class="media-body pr-10">
                        ...
                        <a class="dropdown-item text-center mb-0" href="javascript:void(0)">
                            <i class="las la-flag mr-5"></i> View All
                        </a>
                    </div>
                </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-left min-width-300" aria-labelledby="page-header-notifications">
                        ...
                        <ul class="list-unstyled my-20">
                            ...
                            <li>
                                <a class="text-body-color-dark media mb-15" href="javascript:void(0)">
                                    <div class="ml-5 mr-15">
                                        <i class="las la-fw la-exclamation-triangle text-warning"></i>
                                    </div>
                                    <div class="media-body pr-10">
                                        <p class="mb-0">Please check your payment info since we can’t validate them!</p>
                                        <div class="text-muted font-size-sm font-italic">50 min ago</div>
        ...
        <div id="page-header-loader" class="overlay-header bg-primary">
            <div class="content-header content-header-fullrow text-center">
                <div class="content-header-item">
                    <i class="las la-sun-o fa-spin text-white"></i>
                </div>
            </div>
        </div>
        <!-- END Header Loader -->
    ...
    <footer id="page-footer" class="opacity-0">
        <div class="content py-20 font-size-xs clearfix">
            {{--<div class="float-right">--}}
                {{--Crafted with <i class="las la-heart text-pulse"></i> by <a class="font-w600" href="https://1.envato.market/ydb" target="_blank">pixelcave</a>--}}
            {{--</div>--}}
