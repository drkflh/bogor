<div class="container">
    <?php
        ...
        $invoice = \App\Models\Ecf\Invoice::where('invCode', '=', $invCode)->first();
        ...
        $salesOrder = \App\Models\Ecf\SalesOrder::where('cartSession', '=', $cartSession)->get();
                        ...
                        <div class="invoice-info" id="invoice_wrapper">
                            <div>
                                <div class="row">
                                    <div class="col">
                                        <div class="col">
                                            <div class="text">
                                            <h5><strong>Investor:</strong> {{ $invoice->buyer ?? '--'}}</h5>    
                                            <h5><strong>Mobile :</strong> {{ $invoice->mobile ?? '-'}}</h5> 
                                            <h5><strong>Email :</strong> {{ $invoice->email ?? '-'}}</h5>                                             
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="invoice-center">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td class="col-md-4"><h5 >{{ $sales->campaignTitle ?? '-'}}</h5></td>
                            ...
                            <div class="invoice-bottom pb-80">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="{{ url('ecf/etalase') }}" class="btn mb-20 w-50"><i class="fi-rs-arrow-left mr-10"></i>Back to Shop</a>
                                    </div>
                                    <div class="col-md-6 ">
                                        <div class="row">
                                            <div class="col text-end">  
