...
<div class="row pb-3">
        <div class="col-12">
            <p style="color:#000000; font-size: 15px;margin-bottom:3px;"><b><u>Data Campaign </u></b></p>
        </div>
    </div>
    <div class="row">
        <div class="col-4">
            <p style="color:#000000; font-size: 13px;"><b>Kampanye</b></p>
        </div>
        <div class="col-8">
            <p style="color:#000000; font-size: 13px;"><b>@{{ _.get(content, 'campaignName') }}</b></p>
        </div>
    </div>
    <div class="row">
        <div class="col-4">
            <p style="color:#000000; font-size: 13px;"><b>Perusahaan </b></p>
        </div>
        <div class="col-8">
