<div class="row" style="margin-top:30px;">
    <div class="col-7" style="border-right: thin solid #000000; ">
        <div class="row">
            <div class="col-3">
            <label style="color:#000;font-weight:bold;">Vendor Class</label>
                {!! $vendorClass !!}
            </div>
            <div class="col-5">
            <label style="color:#000;font-weight:bold;">Vendor Name</label>
                {!! $coyName !!}
            </div>
            <div class="col-1">
            ...
            <div class="col-3">
            <label style="color:#000;font-weight:bold;">Vendor Code</label>
                {!! $vendorCode !!}
            </div>
        </div>
    ...
    <div class="col-5">
        <div class="row">
            ...
            <div class="container">
                ...
                <div  class="row">
                    <div  class="col-5" >
                            <label style="color:#000;font-weight:bold;">Vendor Tax ID</label>
                            {!! $vendorTaxId !!}
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <label style="margin-top:20px;color:#000000;margin-right:10px;font-weight:bold;">Upload : </label>
                        <div class="col-md-6 col-xs-12" style="bottom:3px;right:8px;height:20px;width:10px;">
                            <a href="#">{!! $taxIdNpwp !!}</a>
                        </div>
                    </div>
                </div>
