    ...
    <template slot="Subject" slot-scope="text, record">
        <div class="tbl" style="font-size: 10pt;color: darkslategray;;">
            ...
            <div class="tcell"  style="width: 100%;">
                <b>Topic: </b> @{{ record.Topic }} <span style="margin-left: 20px;cursor: pointer;color: blue;" :id="'pop-' + record.FCallCode" variant="primary"><i class="las la-info-circle" ></i></span>
                <b-popover
    ...
    <template v-else-if="props.column.field == 'Subject'">
        <div class="tbl" style="font-size: 10pt;color: darkslategray;;">
            <div class="text-350" style="display: table-cell;">
                ...
                <template v-else>
                    <span @click="showPdf( props.row.FileUrl, props.row )" style="cursor: pointer;">
            ...
            <div class="tcell"  style="width: 100%;">
                <b>Topic: </b> @{{ props.row.Topic }} <span style="margin-left: 20px;cursor: pointer;color: blue;" :id="'pop-' + props.row.FCallCode" variant="primary"><i class="las la-info-circle" ></i></span>
                <b-popover
