...
<div class="form-row" >
   ...
   <div  style="padding-left:20px;padding-right: 15px;width: 170px;" >
       <label style="color:#000000;font-weight:bold;">Request Date</label>
   ...
   <div style="width: 200px;">
       <label style="color:#000000;font-weight:bold;">Request No</label>
       {!! $requestNo !!}
   </div>
   ...
   <div  class="row">
       <div  class="col-5" >
           ...
           <div class="row" style="margin-top: 13px">
            ...
            <div class="row" >
                <div class="col-8" style="margin-top: 10px;margin-left:5px;margin-right:-5px;">
                    <label style="color:#000000;font-weight:bold;margin-left:-5px;">Discount:</label>
                    <div class="row">
                        <div class="col-6">
...
<div class="col-4" style="margin-bottom:30px;">
   <div class="form-row" >
       <div  style="padding-left:20px;padding-right: 15px;width:180px;" >
           <label style="color:#000000;font-weight:bold;margin-bottom:20px;">Request By</label>
           {!! $requestBy !!}
       </div>
       <div  style="padding-left:20px;padding-right: 15px;width:180px;" >
           <label style="color:#000000;font-weight:bold;margin-bottom:20px;">Recommended By</label>
           {!! $recomendedBy!!}
       </div>
   </div>
</div>
<div class="col-4" style="border-right: thin solid #000000; ">
   <div class="form-row" >
       <div  style="padding-left:10px;padding-right: 15px;width:180px;" >
           <label style="color:#000000;font-weight:bold;margin-bottom:20px;">Audited By</label>
               {!! $auditedBy!!}
       </div>
       <div  style="padding-left:20px;padding-right: 15px;width:180px;" >
           <label style="color:#000000;font-weight:bold;margin-bottom:20px;">Authorized By</label>
               {!! $authorizedBy!!}
       </div>
   </div>
</div>
<div class="col-3" style="margin-left: 10px;" >
   <div class="row" >
       <label style="color:#000000;font-weight:bold;font-size:17px;margin:1px 0;">Purpose of Purchase</label>
   </div>
   <div class="row">
...
<b-tab title="Detail" active>
   ...
   <div class="row" style="float:right;">
    <div style="margin-top:-10px;margin-right:70px;margin-bottom:10px;">
        <div>
            <div class="row">
                <div class="col-6">
