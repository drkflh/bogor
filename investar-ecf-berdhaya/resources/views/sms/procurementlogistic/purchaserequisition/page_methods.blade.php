...
setApprovers(){
    this.requestBy = _.get(this.requestByObj, 'name');
    this.auditedBy = _.get(this.auditedByObj, 'name');
    this.recomendedBy = _.get(this.recomendedByObj, 'name');
    this.authorizedBy = _.get(this.authorizedByObj, 'name');
},
