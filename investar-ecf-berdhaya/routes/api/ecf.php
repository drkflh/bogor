...
Route::group(['prefix' => 'v1/mobile','middleware'=>['api'] ], function (){
	...
	\App\Helpers\Util::makeApiRoute('ecf/biz-profile', 'Api\Ecf\BizProfileController');
	\App\Helpers\Util::makeApiRoute('ecf/campaign', 'Api\Ecf\CampaignController');
	\App\Helpers\Util::makeApiRoute('ecf/product', 'Api\Ecf\ProductController');
	\App\Helpers\Util::makeApiRoute('ecf/citizenship', 'Api\ecf\CitizenshipController');
